...
/*  80 */     func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(OreSpawnMain.TheQueen_stats.health);
...
/* 131 */     if (e != null && (e instanceof TheQueen || e instanceof QueenHead)) return false; 
/* 132 */     e = par1DamageSource.func_76364_f();
/* 133 */     if (e != null && (e instanceof TheQueen || e instanceof QueenHead)) return false;
/*     */     
/* 135 */     List var5 = this.field_70170_p.func_72872_a(TheQueen.class, this.field_70121_D.func_72314_b(48.0D, 32.0D, 48.0D));
/* 136 */     Iterator<Entity> var2 = var5.iterator();
/* 137 */     Entity var3 = null;
/* 138 */     TheQueen var4 = null;
/*     */     
/* 140 */     if (var2.hasNext()) {
/*     */ 
/*     */       
/* 143 */       var3 = var2.next();
/* 144 */       var4 = (TheQueen)var3;
...
/*     */ 
/*     */       
/* 241 */       List var5 = this.field_70170_p.func_72872_a(TheQueen.class, this.field_70121_D.func_72314_b(32.0D, 32.0D, 32.0D));
/* 242 */       Iterator<Entity> var2 = var5.iterator();
/* 243 */       Entity var3 = null;
/* 244 */       TheQueen var4 = null;
/*     */       
/* 246 */       if (var2.hasNext()) {
/*     */         
/* 248 */         var3 = var2.next();
/* 249 */         var4 = (TheQueen)var3;
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\QueenHead.class
