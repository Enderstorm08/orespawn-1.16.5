...
/*  39 */     func_77637_a(CreativeTabs.field_78037_j);
...
/*     */     
/*  82 */     this.original_d = this.field_77879_b;
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 120 */     if (a != null) {
/* 121 */       if (a.e_protection != 0) par1ItemStack.func_77966_a(Enchantment.field_77332_c, a.e_protection); 
/* 122 */       if (a.e_fireprotection != 0) par1ItemStack.func_77966_a(Enchantment.field_77329_d, a.e_fireprotection); 
/* 123 */       if (a.e_blastprotection != 0) par1ItemStack.func_77966_a(Enchantment.field_77327_f, a.e_blastprotection); 
/* 124 */       if (a.e_projectileprotection != 0) par1ItemStack.func_77966_a(Enchantment.field_77328_g, a.e_projectileprotection); 
/* 125 */       if (a.e_unbreaking != 0) par1ItemStack.func_77966_a(Enchantment.field_77347_r, a.e_unbreaking); 
/* 126 */       if (this.armor_type == 3 && 
/* 127 */         a.e_featherfalling != 0) par1ItemStack.func_77966_a(Enchantment.field_77330_e, a.e_featherfalling);
/*     */       
/* 129 */       if (this.armor_type == 0) {
/* 130 */         if (a.e_respiration != 0) par1ItemStack.func_77966_a(Enchantment.field_77340_h, a.e_respiration); 
/* 131 */         if (a.e_aquaaffinity != 0) par1ItemStack.func_77966_a(Enchantment.field_77341_i, a.e_aquaaffinity);
/*     */       
/*     */       } 
/*     */     } 
/*     */   }
...
/* 170 */       if (enchanted > 0) {
/* 171 */         lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77332_c.field_77352_x, stack);
/* 172 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77329_d.field_77352_x, stack); 
/* 173 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77327_f.field_77352_x, stack); 
/* 174 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77328_g.field_77352_x, stack); 
/* 175 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77340_h.field_77352_x, stack); 
/* 176 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77341_i.field_77352_x, stack); 
/* 177 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77347_r.field_77352_x, stack); 
/* 178 */         if (lvl <= 0) lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77330_e.field_77352_x, stack); 
/* 179 */         if (lvl == 0) {
/* 180 */           if (a.e_protection != 0) stack.func_77966_a(Enchantment.field_77332_c, a.e_protection); 
/* 181 */           if (a.e_fireprotection != 0) stack.func_77966_a(Enchantment.field_77329_d, a.e_fireprotection); 
/* 182 */           if (a.e_blastprotection != 0) stack.func_77966_a(Enchantment.field_77327_f, a.e_blastprotection); 
/* 183 */           if (a.e_projectileprotection != 0) stack.func_77966_a(Enchantment.field_77328_g, a.e_projectileprotection); 
/* 184 */           if (a.e_unbreaking != 0) stack.func_77966_a(Enchantment.field_77347_r, a.e_unbreaking); 
/* 185 */           if (this.armor_type == 3 && 
/* 186 */             a.e_featherfalling != 0) stack.func_77966_a(Enchantment.field_77330_e, a.e_featherfalling);
/*     */           
/* 188 */           if (this.armor_type == 0) {
/* 189 */             if (a.e_respiration != 0) stack.func_77966_a(Enchantment.field_77340_h, a.e_respiration); 
/* 190 */             if (a.e_aquaaffinity != 0) stack.func_77966_a(Enchantment.field_77341_i, a.e_aquaaffinity);
/*     */           
/*     */           } 
/*     */         } 
/*     */       } 
...
/* 299 */       if (player != null) {
/*     */         
/* 301 */         boots = player.func_71124_b(1);
/*     */         
/* 303 */         if (boots != null && ((
/* 304 */           boots.func_77973_b() == OreSpawnMain.RoyalBoots && OreSpawnMain.RoyalGlideEnable != 0) || boots.func_77973_b() == OreSpawnMain.PeacockFeatherBoots)) {
/*     */           
/* 306 */           if (player.field_70181_x < -0.10000000149011612D) player.field_70181_x = -0.10000000149011612D; 
/* 307 */           player.field_70143_R = 0.0F;
/*     */         } 
/*     */       } 
/*     */     }
/*     */ 
...
/* 316 */       if (player != null) {
/*     */         
/* 318 */         boots = player.func_71124_b(1);
/*     */         
/* 320 */         if (boots != null && 
/* 321 */           boots.func_77973_b() == OreSpawnMain.QueenBoots && OreSpawnMain.RoyalGlideEnable != 0) {
/*     */           
/* 323 */           if (player.field_70181_x < -0.25D) player.field_70181_x = -0.25D; 
/* 324 */           player.field_70143_R = 0.0F;
/*     */         } 
/*     */       } 
/*     */     }
/*     */   }
...
/* 334 */     this.field_77791_bV = iconRegister.func_94245_a("OreSpawn:" + func_77658_a().substring(5));
/*     */   }
/*     */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ItemOreSpawnArmor.class
