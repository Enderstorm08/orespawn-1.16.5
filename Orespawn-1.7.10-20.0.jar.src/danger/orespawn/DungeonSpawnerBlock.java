...
/*     */     {
/*     */       
/*  47 */       par1World.func_72869_a("fireworksSpark", (par2 + par1World.field_73012_v.nextFloat()), par3 + par1World.field_73012_v.nextFloat(), (par4 + par1World.field_73012_v.nextFloat()), (par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0D, par1World.field_73012_v.nextFloat() / 2.0D, (par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0D);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */       return; 
/*  60 */     world.func_147464_a(x, y, z, (Block)this, 400);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  69 */     super.func_149664_b(par1World, par2, par3, par4, par5);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public void func_149674_a(World world, int clickedX, int clickedY, int clickedZ, Random par5Random) {
/*  79 */     if (world.field_72995_K)
/*     */       return; 
/*  81 */     world.func_147465_d(clickedX, clickedY, clickedZ, Blocks.field_150350_a, 0, 2);
/*  82 */     world.func_147465_d(clickedX, clickedY + 1, clickedZ, Blocks.field_150350_a, 0, 2);
/*     */     
/*  84 */     int type = world.field_73012_v.nextInt(50);
...
/* 165 */     this.field_149761_L = iconRegister.func_94245_a("OreSpawn:" + func_149739_a().substring(5));
/*     */   }
/*     */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\DungeonSpawnerBlock.class
