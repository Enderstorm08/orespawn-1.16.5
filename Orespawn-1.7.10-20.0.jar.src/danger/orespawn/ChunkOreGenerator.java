...
/*  33 */             Block b = Blocks.field_150350_a;
/*  34 */             switch (m) { case 0:
...
/*  47 */             Block b = Blocks.field_150350_a;
/*  48 */             switch (m) { case 0:
...
/* 246 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150482_ag, OreSpawnMain.Diamond_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */       
...
/* 257 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150484_ah, OreSpawnMain.BlkDiamond_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */ 
...
/* 269 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150412_bA, OreSpawnMain.Emerald_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */       
...
/* 280 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150475_bE, OreSpawnMain.BlkEmerald_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */ 
...
/* 292 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150352_o, OreSpawnMain.Gold_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */       
...
/* 303 */             generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150340_R, OreSpawnMain.BlkGold_stats.clumpsize);
/*     */           }
/*     */         } 
/*     */       }
/*     */ 
...
/* 326 */     double d0 = ((par3 + 8) + MathHelper.func_76126_a(f) * numberOfBlocks / 8.0F);
/* 327 */     double d1 = ((par3 + 8) - MathHelper.func_76126_a(f) * numberOfBlocks / 8.0F);
/* 328 */     double d2 = ((par5 + 8) + MathHelper.func_76134_b(f) * numberOfBlocks / 8.0F);
/* 329 */     double d3 = ((par5 + 8) - MathHelper.func_76134_b(f) * numberOfBlocks / 8.0F);
...
/* 339 */       double d10 = (MathHelper.func_76126_a(l * 3.1415927F / numberOfBlocks) + 1.0F) * d9 + 1.0D;
/* 340 */       double d11 = (MathHelper.func_76126_a(l * 3.1415927F / numberOfBlocks) + 1.0F) * d9 + 1.0D;
/* 341 */       int i1 = MathHelper.func_76128_c(d6 - d10 / 2.0D);
/* 342 */       int j1 = MathHelper.func_76128_c(d7 - d11 / 2.0D);
/* 343 */       int k1 = MathHelper.func_76128_c(d8 - d10 / 2.0D);
/* 344 */       int l1 = MathHelper.func_76128_c(d6 + d10 / 2.0D);
/* 345 */       int i2 = MathHelper.func_76128_c(d7 + d11 / 2.0D);
/* 346 */       int j2 = MathHelper.func_76128_c(d8 + d10 / 2.0D);
/*     */       
...
/*     */                 
/* 366 */                 if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && bid == Blocks.field_150348_b)
/*     */                 {
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkOreGenerator.class
