...
/* 122 */     this.field_147435_p = par1World.func_72912_H().func_76067_t();
...
/*     */         
/* 138 */         float f = 10.0F / MathHelper.func_76129_c((j * j + k * k) + 0.2F);
...
/* 156 */     byte b0 = 63;
/* 157 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76937_a(this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
...
/* 203 */                 if ((d15 += d16) > 0.0D) {
/*     */                   
/* 205 */                   p_147424_3_[j3 += short1] = Blocks.field_150348_b;
/*     */                 }
/* 207 */                 else if (k2 * 8 + l2 < b0) {
/*     */                   
/* 209 */                   p_147424_3_[j3 += short1] = Blocks.field_150355_j;
/*     */                 }
/*     */                 else {
/*     */                   
...
/* 238 */     this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (p_147422_1_ * 16), (p_147422_2_ * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
/*     */     
...
/* 245 */         biomegenbase.func_150573_a(this.worldObj, this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k, p_147422_2_ * 16 + l, this.stoneNoise[l + k * 16]);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 255 */     return func_73154_d(par1, par2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 268 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76933_b(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
...
/* 299 */     this.field_147426_g = this.noiseGen6.func_76305_a(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
/* 300 */     this.field_147427_d = this.field_147429_l.func_76304_a(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
/* 301 */     this.field_147428_e = this.field_147431_j.func_76304_a(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
/* 302 */     this.field_147425_f = this.field_147432_k.func_76304_a(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
...
/* 324 */             float f3 = biomegenbase1.field_76748_D;
/* 325 */             float f4 = biomegenbase1.field_76749_E;
/*     */             
/* 327 */             if (this.field_147435_p == WorldType.field_151360_e && f3 > 0.0F) {
/*     */               
/* 329 */               f3 = 1.0F + f3 * 2.0F;
/* 330 */               f4 = 1.0F + f4 * 4.0F;
/*     */             } 
...
/*     */             
/* 335 */             if (biomegenbase1.field_76748_D > biomegenbase.field_76748_D)
/*     */             {
/* 337 */               f5 /= 2.0F;
/*     */             }
/*     */             
...
/* 400 */           double d10 = MathHelper.func_151238_b(d7, d8, d9) - d6;
/*     */           
/* 402 */           if (j2 > 29) {
/*     */             
...
/* 428 */     BlockFalling.field_149832_M = true;
/* 429 */     int k = par2 * 16;
/* 430 */     int l = par3 * 16;
/* 431 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(k + 16, l + 16);
/* 432 */     this.rand.setSeed(this.worldObj.func_72905_C());
/* 433 */     long i1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 434 */     long j1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 435 */     this.rand.setSeed(par2 * i1 + par3 * j1 ^ this.worldObj.func_72905_C());
...
/*     */       
/* 442 */       this.mineshaftGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/*     */       
/* 444 */       this.strongholdGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/* 445 */       this.scatteredFeatureGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 452 */     if (biomegenbase != BiomeGenBase.field_76769_d && biomegenbase != BiomeGenBase.field_76786_s && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAKE)) {
/*     */ 
/*     */       
/* 455 */       int i = k + this.rand.nextInt(16) + 8;
/* 456 */       int l1 = this.rand.nextInt(256);
/* 457 */       int i2 = l + this.rand.nextInt(16) + 8;
/* 458 */       (new WorldGenLakes(Blocks.field_150355_j)).func_76484_a(this.worldObj, this.rand, i, l1, i2);
/*     */     } 
/*     */     
...
/*     */       {
/* 469 */         (new WorldGenLakes(Blocks.field_150353_l)).func_76484_a(this.worldObj, this.rand, i, l1, i2);
/*     */       }
/*     */     } 
/*     */     
...
/* 479 */       (new WorldGenDungeons()).func_76484_a(this.worldObj, this.rand, l1, i2, j2);
/*     */     } 
/*     */     
/* 482 */     biomegenbase.func_76728_a(this.worldObj, this.rand, k, l);
/* 483 */     SpawnerAnimals.func_77191_a(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
/* 484 */     k += 8;
/* 485 */     l += 8;
/*     */     
...
/*     */         
/* 492 */         int i2 = this.worldObj.func_72874_g(k + k1, l + l1);
/*     */         
/* 494 */         if (this.worldObj.func_72884_u(k1 + k, i2 - 1, l1 + l))
/*     */         {
/* 496 */           this.worldObj.func_147465_d(k1 + k, i2 - 1, l1 + l, Blocks.field_150432_aD, 0, 2);
/*     */         }
/*     */         
/* 499 */         if (this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true))
/*     */         {
/* 501 */           this.worldObj.func_147465_d(k1 + k, i2, l1 + l, Blocks.field_150431_aC, 0, 2);
/*     */         }
/*     */       } 
/*     */     } 
/*     */ 
/*     */ 
/*     */     
/* 508 */     BlockFalling.field_149832_M = false;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 558 */     BiomeGenBase var5 = this.worldObj.func_72807_a(par2, par4);
/* 559 */     List l = null;
/* 560 */     if (var5 != null) {
/* 561 */       l = var5.func_76747_a(par1EnumCreatureType);
...
/* 630 */             this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(VelocityRaptor.class, 5, 2, 4));
/*     */           }
/* 632 */           if (OreSpawnMain.DragonflyEnable != 0) {
/* 633 */             this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Dragonfly.class, 10, 1, 3));
/*     */           }
/* 635 */           if (OreSpawnMain.CamarasaurusEnable != 0) {
/* 636 */             this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Camarasaurus.class, 3, 2, 4));
/*     */           }
/* 638 */           if (OreSpawnMain.BaryonyxEnable != 0) {
/* 639 */             this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Baryonyx.class, 10, 4, 8));
/*     */           }
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkProviderOreSpawn2.class
