...
/* 26 */     this.Shape1.func_78789_a(-2.0F, 3.9F, 0.0F, 4, 1, 1);
/* 27 */     this.Shape1.func_78793_a(0.0F, 0.0F, 0.0F);
/* 28 */     this.Shape1.func_78787_b(64, 32);
/* 29 */     this.Shape1.field_78809_i = true;
/* 30 */     setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
/* 31 */     this.Shape2 = new ModelRenderer(this, 0, 7);
/* 32 */     this.Shape2.func_78789_a(-4.0F, 7.6F, 0.0F, 8, 2, 2);
/* 33 */     this.Shape2.func_78793_a(0.0F, 0.0F, -0.5F);
/* 34 */     this.Shape2.func_78787_b(64, 32);
/* 35 */     this.Shape2.field_78809_i = true;
/* 36 */     setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
/* 37 */     this.Shape3 = new ModelRenderer(this, 0, 0);
/* 38 */     this.Shape3.func_78789_a(-7.0F, 13.7F, 0.0F, 14, 3, 3);
/* 39 */     this.Shape3.func_78793_a(0.0F, 0.0F, -1.0F);
/* 40 */     this.Shape3.func_78787_b(64, 32);
...
/*    */     
/* 51 */     super.func_78088_a(entity, f, f1, f2, f3, f4, f5);
/* 52 */     func_78087_a(f, f1, f2, f3, f4, f5, entity);
/*    */     
/* 54 */     ri = r.getRenderInfo();
/* 55 */     GL11.glRotatef(ri.rf1, 1.0F, 0.0F, 0.0F); int i;
/* 56 */     for (i = 0; i < 8; i++) {
/* 57 */       this.Shape1.field_78808_h = newangle;
/* 58 */       this.Shape1.func_78785_a(f5);
...
/* 64 */     for (i = 0; i < 8; i++) {
/* 65 */       this.Shape2.field_78808_h = newangle;
...
/* 72 */     for (i = 0; i < 8; i++) {
/* 73 */       this.Shape3.field_78808_h = newangle;
/* 74 */       this.Shape3.func_78785_a(f5);
...
/* 95 */     super.func_78087_a(par1, par2, par3, par4, par5, par6, par7Entity);
/*    */   }
/*    */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ModelRotator.class
