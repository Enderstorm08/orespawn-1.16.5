...
/*  33 */     this.cage_id = j;
/*  34 */     this.field_77777_bU = 16;
/*  35 */     func_77637_a(CreativeTabs.field_78026_f);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  50 */       if (!par3EntityPlayer.field_71075_bZ.field_75098_d)
/*     */       {
/*  52 */         par1ItemStack.field_77994_a--;
/*     */       }
/*     */       
/*  55 */       par2World.func_72956_a((Entity)par3EntityPlayer, "random.bow", 0.5F, 0.4F / (field_77697_d.nextFloat() * 0.4F + 0.8F));
/*     */       
/*  57 */       if (!par2World.field_72995_K)
/*     */       {
/*     */         
/*  60 */         par2World.func_72838_d((Entity)new EntityCage(par2World, par3EntityPlayer, this.cage_id));
/*     */       }
/*     */     } 
/*     */ 
/*     */     
...
/*     */       
/*  92 */       par2EntityPlayer.field_70170_p.func_72869_a("smoke", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
/*  93 */       par2EntityPlayer.field_70170_p.func_72869_a("explode", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
/*  94 */       par2EntityPlayer.field_70170_p.func_72869_a("reddust", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
/*     */     } 
/*  96 */     par2EntityPlayer.field_70170_p.func_72956_a((Entity)par2EntityPlayer, "random.explode", 1.0F, 1.5F);
/*     */     
/*  98 */     if (par3World.field_72995_K)
/*     */     {
/*     */       
/* 101 */       return true;
/*     */     }
...
/*     */       
/* 355 */       if (ent != null) {
/* 356 */         ent.func_145779_a(OreSpawnMain.CageEmpty, 1);
/*     */ 
/*     */         
/* 359 */         if (entityID == 51 && skelly_type != 0) {
/*     */           
/* 361 */           EntitySkeleton sk = (EntitySkeleton)ent;
/* 362 */           sk.func_82201_a(skelly_type);
/*     */         } 
/*     */         
/* 365 */         if (ent instanceof EntityLiving && par1ItemStack.func_82837_s())
/*     */         {
/* 367 */           ((EntityLiving)ent).func_94058_c(par1ItemStack.func_82833_r());
/*     */         }
/*     */       }
/*     */     
/*     */     } else {
...
/*     */ 
/*     */     
/* 377 */     if (!par2EntityPlayer.field_71075_bZ.field_75098_d)
/*     */     {
/* 379 */       par1ItemStack.field_77994_a--;
/*     */     }
/*     */     
/* 382 */     return true;
/*     */   }
...
/*     */     
/* 394 */     if (name == null) {
/* 395 */       var8 = EntityList.func_75616_a(par1, par0World);
/*     */     } else {
/* 397 */       var8 = EntityList.func_75620_a(name, par0World);
/*     */     } 
/*     */     
/* 400 */     if (var8 != null) {
/*     */ 
/*     */       
/* 403 */       var8.func_70012_b(par2, par4, par6, par0World.field_73012_v.nextFloat() * 360.0F, 0.0F);
/*     */ 
/*     */       
/* 406 */       if ((par1 == 100 || par1 == 120) && var8 instanceof EntityLiving) {
/*     */         
/* 408 */         EntityLiving sk = (EntityLiving)var8;
/* 409 */         sk.func_110161_a((IEntityLivingData)null);
/*     */       } 
/* 411 */       par0World.func_72838_d(var8);
/*     */       
/* 413 */       ((EntityLiving)var8).func_70642_aH();
/*     */     } 
/*     */     
/* 416 */     return var8;
/*     */   }
...
/* 425 */     this.field_77791_bV = iconRegister.func_94245_a("OreSpawn:" + func_77658_a().substring(5));
/*     */   }
/*     */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\CritterCage.class
