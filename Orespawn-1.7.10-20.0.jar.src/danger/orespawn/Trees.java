...
/*   26 */       OreSpawnMain.setBlockFast(world, x + i * dirx, y, z + i * dirz, Blocks.field_150364_r, 0, 2);
/*      */       
/*   28 */       if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx, y + 1, z + i * dirz)) {
/*   29 */         OreSpawnMain.setBlockFast(world, x + i * dirx, y + 1, z + i * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */       }
/*   31 */       if (i < length / 3 && 
/*   32 */         Blocks.field_150350_a == world.func_147439_a(x + i * dirx, y + 2, z + i * dirz)) {
/*   33 */         OreSpawnMain.setBlockFast(world, x + i * dirx, y + 2, z + i * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */       }
/*      */       
/*   36 */       if (i > length / 3) {
/*      */         
/*   38 */         if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx + dirz, y, z + i * dirz + dirx)) {
/*   39 */           OreSpawnMain.setBlockFast(world, x + i * dirx + dirz, y, z + i * dirz + dirx, (Block)Blocks.field_150362_t, 0, 2);
/*      */         }
/*   41 */         if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx - dirz, y, z + i * dirz - dirx)) {
/*   42 */           OreSpawnMain.setBlockFast(world, x + i * dirx - dirz, y, z + i * dirz - dirx, (Block)Blocks.field_150362_t, 0, 2);
/*      */         }
/*      */       } 
/*      */     } 
/*      */ 
/*      */     
/*   48 */     if (Blocks.field_150350_a == world.func_147439_a(x + (length + 1) * dirx, y, z + (length + 1) * dirz)) {
/*   49 */       OreSpawnMain.setBlockFast(world, x + (length + 1) * dirx, y, z + (length + 1) * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */     }
/*   51 */     if (Blocks.field_150350_a == world.func_147439_a(x + (length + 2) * dirx, y, z + (length + 2) * dirz)) {
/*   52 */       OreSpawnMain.setBlockFast(world, x + (length + 2) * dirx, y, z + (length + 2) * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*   75 */     Block bid = world.func_147439_a(x, y, z);
/*   76 */     if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d) {
/*      */       return;
/*      */     }
/*      */     
/*   80 */     int height = world.field_73012_v.nextInt(8) + 40;
/*   81 */     int width = world.field_73012_v.nextInt(4) + 8;
/*      */ 
/*      */     
/*   84 */     for (int j = 0; j < height; j++) {
/*   85 */       OreSpawnMain.setBlockFast(world, x, j + y, z, Blocks.field_150364_r, 0, 2);
/*   86 */       if (j > height / 5) {
/*      */         
/*   88 */         OreSpawnMain.setBlockFast(world, x + dirx, j + y, z + dirz, (Block)Blocks.field_150362_t, 0, 2);
...
/*      */ 
/*      */     
/*   97 */     OreSpawnMain.setBlockFast(world, x, y + height, z, (Block)Blocks.field_150362_t, 0, 2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  107 */       if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx, y + 1, z + i * dirz)) {
/*  108 */         OreSpawnMain.setBlockFast(world, x + i * dirx, y + 1, z + i * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */       }
/*      */       
/*  111 */       if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx + dirz, y, z + i * dirz + dirx)) {
/*  112 */         OreSpawnMain.setBlockFast(world, x + i * dirx + dirz, y, z + i * dirz + dirx, (Block)Blocks.field_150362_t, 0, 2);
/*      */       }
/*  114 */       if (Blocks.field_150350_a == world.func_147439_a(x + i * dirx - dirz, y, z + i * dirz - dirx)) {
/*  115 */         OreSpawnMain.setBlockFast(world, x + i * dirx - dirz, y, z + i * dirz - dirx, (Block)Blocks.field_150362_t, 0, 2);
/*      */       }
/*      */     } 
/*      */ 
/*      */     
/*  120 */     if (Blocks.field_150350_a == world.func_147439_a(x + length * dirx, y, z + length * dirz)) {
/*  121 */       OreSpawnMain.setBlockFast(world, x + length * dirx, y, z + length * dirz, (Block)Blocks.field_150362_t, 0, 2);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  131 */     Block bid = world.func_147439_a(x, y, z);
/*  132 */     if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d) {
/*      */       return;
/*      */     }
/*      */     
/*  136 */     int height = world.field_73012_v.nextInt(15) + 190;
/*      */     
/*  138 */     if (height - y < 20)
/*      */       return; 
/*  140 */     int width = world.field_73012_v.nextInt(10) + 25;
/*      */ 
/*      */     
/*  143 */     for (int j = y; j <= height; j++) {
/*  144 */       OreSpawnMain.setBlockFast(world, x, j, z, OreSpawnMain.MySkyTreeLog, 0, 2);
/*      */     }
/*  146 */     OreSpawnMain.setBlockFast(world, x, height + 1, z, (Block)Blocks.field_150362_t, 0, 2);
/*      */ 
/*      */     
...
/*      */     
/*  155 */     height -= 5;
/*  156 */     height -= world.field_73012_v.nextInt(4);
/*  157 */     width /= 3;
...
/*      */ 
/*      */     
/*  175 */     Block bid = world.func_147439_a(x, y - 1, z);
/*  176 */     if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*  177 */       bid = world.func_147439_a(x, y - 2, z);
/*  178 */       if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*  179 */         bid = world.func_147439_a(x, y - 3, z);
/*  180 */         if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*      */           
/*  182 */           world.func_147465_d(x, y, z, Blocks.field_150350_a, 0, 2);
/*      */           return;
/*      */         } 
/*  185 */         realy = y - 3;
/*      */       } else {
...
/*      */     } 
/*      */     
/*  214 */     bid = world.func_147439_a(x, realy + 4, z);
...
/*  221 */         if (j != 0 || i != 0) {
/*  222 */           bid = world.func_147439_a(x + i, realy + 3, z + j);
...
/*      */       } 
/*      */     } 
/*  231 */     Block bidm = Blocks.field_150350_a;
/*  232 */     for (int tries = 0; tries < 20 && (bidm == Blocks.field_150350_a || bidm == OreSpawnMain.MyDT); tries++) {
/*  233 */       i = world.field_73012_v.nextInt(5) - 2;
/*  234 */       int j = world.field_73012_v.nextInt(5) - 2;
/*  235 */       bidm = world.func_147439_a(x + i, realy + 1, z + j);
/*  236 */       int meta = world.func_72805_g(x + i, realy + 1, z + j);
/*  237 */       if (bidm != Blocks.field_150350_a && bidm != OreSpawnMain.MyDT)
/*      */       {
/*  239 */         for (int k = 0; k < 20; k++) {
/*  240 */           i = world.field_73012_v.nextInt(5) - 2;
/*  241 */           j = world.field_73012_v.nextInt(5) - 2;
/*  242 */           bid = world.func_147439_a(x + i, realy + 1, z + j);
/*  243 */           if (bid == Blocks.field_150350_a) {
/*      */             
/*  245 */             world.func_147465_d(x + i, realy + 1, z + j, bidm, meta, 2);
/*      */             return;
/*      */           } 
/*      */         } 
/*      */       }
...
/*  263 */           Block bid = world.func_147439_a(x + l1, y + l3, z + l2);
/*  264 */           if (bid == Blocks.field_150350_a) OreSpawnMain.setBlockFast(world, x + l1, y + l3, z + l2, OreSpawnMain.MyExperienceLeaves, 0, 2);
/*      */         
/*      */         } 
/*      */       } 
/*      */     } 
...
/*  276 */     int j = y;
/*  277 */     int k = z;
/*  278 */     int grow = 4 + world.field_73012_v.nextInt(2); int n;
/*  279 */     for (n = 0; n < grow; n++) {
/*  280 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
...
/*  286 */       k2 = k;
/*      */     } 
/*  288 */     grow = 4 + world.field_73012_v.nextInt(3);
/*  289 */     for (n = 0; n < grow; n++) {
/*  290 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
/*  291 */       make_leaves(world, i, j, k);
/*  292 */       i += xdir;
/*  293 */       k += zdir;
/*      */     } 
/*  295 */     grow = 4 + world.field_73012_v.nextInt(3);
/*  296 */     for (n = 0; n < grow; n++) {
/*  297 */       OreSpawnMain.setBlockFast(world, i2, j, k2, Blocks.field_150364_r, 0, 2);
...
/*      */     
/*  303 */     j2 = --j;
/*  304 */     grow = 3 + world.field_73012_v.nextInt(3);
/*  305 */     for (n = 0; n < grow; n++) {
/*  306 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
/*  307 */       make_leaves(world, i, j, k);
/*  308 */       i += xdir;
/*  309 */       k += zdir;
/*  310 */       j--;
/*      */     } 
/*  312 */     grow = 3 + world.field_73012_v.nextInt(3);
/*  313 */     for (n = 0; n < grow; n++) {
/*  314 */       OreSpawnMain.setBlockFast(world, i2, j2, k2, Blocks.field_150364_r, 0, 2);
...
/*  330 */     int k = z;
/*      */     
/*  332 */     int grow = 5 + world.field_73012_v.nextInt(4); int n;
/*  333 */     for (n = 0; n < grow; n++) {
/*  334 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
...
/*  340 */       k2 = k;
/*      */     } 
/*  342 */     grow = 6 + world.field_73012_v.nextInt(5);
/*  343 */     for (n = 0; n < grow; n++) {
/*  344 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
/*  345 */       make_leaves(world, i, j, k);
/*  346 */       i += xdir;
/*  347 */       k += zdir;
/*      */     } 
/*  349 */     grow = 6 + world.field_73012_v.nextInt(5);
/*  350 */     for (n = 0; n < grow; n++) {
/*  351 */       OreSpawnMain.setBlockFast(world, i2, j, k2, Blocks.field_150364_r, 0, 2);
...
/*      */     
/*  357 */     j2 = --j;
/*  358 */     grow = 4 + world.field_73012_v.nextInt(4);
/*  359 */     for (n = 0; n < grow; n++) {
/*  360 */       OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
/*  361 */       make_leaves(world, i, j, k);
/*  362 */       i += xdir;
/*  363 */       k += zdir;
/*  364 */       j--;
/*      */     } 
/*  366 */     grow = 4 + world.field_73012_v.nextInt(4);
/*  367 */     for (n = 0; n < grow; n++) {
/*  368 */       OreSpawnMain.setBlockFast(world, i2, j2, k2, Blocks.field_150364_r, 0, 2);
...
/*  382 */     Block bid = world.func_147439_a(x, y, z);
/*  383 */     if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*      */       return;
/*      */     }
/*      */     
/*      */     int j;
...
/*  391 */           OreSpawnMain.setBlockFast(world, x + i, y + j, z + k, Blocks.field_150364_r, 0, 2);
/*      */         }
/*      */       } 
/*      */     } 
...
/*  404 */           OreSpawnMain.setBlockFast(world, x + i, y + j, z + k, Blocks.field_150364_r, 0, 2);
/*      */         }
/*      */       } 
/*      */     } 
...
/*      */ 
/*      */     
/*  414 */     int grow = 5 + world.field_73012_v.nextInt(6);
/*  415 */     for (j = 19; j < 19 + grow; j++) {
/*  416 */       for (int i = 0; i < 2; i++) {
/*  417 */         for (int k = 0; k < 2; k++) {
/*  418 */           OreSpawnMain.setBlockFast(world, x + i, y + j, z + k, Blocks.field_150364_r, 0, 2);
...
/*      */ 
/*      */     
/*  433 */     Block bid = world.func_147439_a(x, y - 1, z);
/*  434 */     if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*  435 */       bid = world.func_147439_a(x, y - 2, z);
/*  436 */       if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*  437 */         bid = world.func_147439_a(x, y - 3, z);
/*  438 */         if (bid != Blocks.field_150349_c && bid != Blocks.field_150346_d && bid != Blocks.field_150458_ak) {
/*      */           
/*  440 */           OreSpawnMain.setBlockFast(world, x, y, z, Blocks.field_150350_a, 0, 2);
/*      */           return;
/*      */         } 
/*  443 */         realy = y - 3;
/*      */       } else {
...
/*      */ 
/*      */     
/*  454 */     bid = world.func_147439_a(x, realy + 1, z);
/*  455 */     if (bid == Blocks.field_150350_a) {
/*  456 */       OreSpawnMain.setBlockFast(world, x, realy + 1, z, OreSpawnMain.MySkyTreeLog, 0, 2);
/*      */     }
/*  458 */     if (world.field_73012_v.nextInt(2) == 1) {
/*  459 */       bid = world.func_147439_a(x, realy + 2, z);
/*  460 */       if (bid == Blocks.field_150350_a) {
/*  461 */         OreSpawnMain.setBlockFast(world, x, realy + 2, z, OreSpawnMain.MySkyTreeLog, 0, 2);
/*      */       }
/*  463 */       if (world.field_73012_v.nextInt(2) == 1) {
/*  464 */         bid = world.func_147439_a(x, realy + 3, z);
/*  465 */         if (bid == Blocks.field_150350_a) {
...
/*      */ 
/*      */     
/*  476 */     bid = world.func_147439_a(x, realy + 4, z);
/*  477 */     if (bid == Blocks.field_150350_a) {
/*  478 */       OreSpawnMain.setBlockFast(world, x, realy + 4, z, OreSpawnMain.MyAppleLeaves, 0, 2);
/*      */     }
/*  480 */     for (int i = -1; i <= 1; i++) {
/*  481 */       for (int j = -1; j <= 1; j++) {
/*  482 */         bid = world.func_147439_a(x + i, realy + 3, z + j);
/*  483 */         if (bid == Blocks.field_150350_a) {
...
/*  501 */       int ix = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2) + biasx;
/*  502 */       int iz = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2) + biasz;
/*  503 */       if (ix > 1) ix = 1; 
/*  504 */       if (ix < -1) ix = -1; 
/*  505 */       if (iz > 1) iz = 1; 
/*  506 */       if (iz < -1) iz = -1; 
/*  507 */       int iy = (world.field_73012_v.nextInt(3) > 0) ? 1 : 0;
/*  508 */       x += ix;
/*  509 */       z += iz;
/*  510 */       y += iy;
/*  511 */       Block bid = world.func_147439_a(x, y, z);
/*  512 */       if (bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*      */         return;
/*      */       }
/*  515 */       OreSpawnMain.setBlockFast(world, x, y, z, Blocks.field_150364_r, 0, 2);
/*      */       
/*  517 */       for (int m = -1; m < 2; m++) {
/*  518 */         for (int n = -1; n < 2; n++) {
/*  519 */           if (world.field_73012_v.nextInt(2) == 1) {
/*  520 */             bid = world.func_147439_a(x + m, y, z + n);
/*  521 */             if (bid == Blocks.field_150350_a) {
/*  522 */               OreSpawnMain.setBlockFast(world, x + m, y, z + n, OreSpawnMain.MyAppleLeaves, 0, 2);
/*      */             }
/*      */           } 
/*      */         } 
/*      */       } 
/*  527 */       if (world.field_73012_v.nextInt(2) == 1) {
/*  528 */         bid = world.func_147439_a(x, y + 1, z);
/*  529 */         if (bid == Blocks.field_150350_a) {
...
/*  546 */     int i = 1 + world.field_73012_v.nextInt(3);
/*  547 */     int j = i + world.field_73012_v.nextInt(12);
/*      */     int k;
/*  549 */     for (k = 0; k < i; k++) {
/*  550 */       Block bid = world.func_147439_a(x, y + k, z);
/*  551 */       if (k >= 1 && bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*      */         return;
/*      */       }
/*  554 */       OreSpawnMain.setBlockFast(world, x, y + k, z, Blocks.field_150364_r, 0, 2);
/*      */     } 
/*  556 */     y += i - 1;
/*      */     
/*  558 */     for (k = i; k < j; k++) {
/*  559 */       int ix = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2);
/*  560 */       int iz = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2);
/*  561 */       int iy = (world.field_73012_v.nextInt(4) > 0) ? 1 : 0;
/*  562 */       x += ix;
/*  563 */       z += iz;
/*  564 */       y += iy;
/*  565 */       Block bid = world.func_147439_a(x, y, z);
/*  566 */       if (bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*      */         break;
/*      */       }
/*  569 */       OreSpawnMain.setBlockFast(world, x, y, z, Blocks.field_150364_r, 0, 2);
/*  570 */       if (world.field_73012_v.nextInt(4) == 1) {
/*  571 */         makeScragglyBranch(world, x, y, z, world.field_73012_v.nextInt(1 + j - k), world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2), world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2));
/*      */       }
/*      */       
/*  574 */       for (int m = -1; m < 2; m++) {
/*  575 */         for (int n = -1; n < 2; n++) {
/*  576 */           if (world.field_73012_v.nextInt(2) == 1) {
/*  577 */             bid = world.func_147439_a(x + m, y, z + n);
...
/*      */         } 
/*      */       } 
/*  584 */       if (world.field_73012_v.nextInt(2) == 1) {
/*  585 */         bid = world.func_147439_a(x, y + 1, z);
/*  586 */         if (bid == Blocks.field_150350_a) {
...
/*      */ 
/*      */     
/*  732 */     int grow = 5 + world.field_73012_v.nextInt(5);
...
/*      */ 
/*      */     
/*  743 */     world.func_147465_d(x - 1, y + 1, z, Blocks.field_150474_ac, 0, 2);
/*  744 */     TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(x - 1, y + 1, z);
/*  745 */     if (tileentitymobspawner != null)
/*      */     {
/*  747 */       tileentitymobspawner.func_145881_a().func_98272_a("Fairy");
/*      */     }
/*  749 */     world.func_147465_d(x + 2, y + 1, z, (Block)Blocks.field_150486_ae, 0, 2);
/*  750 */     TileEntityChest chest = (TileEntityChest)world.func_147438_o(x + 2, y + 1, z);
/*  751 */     if (chest != null) {
/*      */ 
/*      */       
/*  754 */       this; WeightedRandomChestContent.func_76293_a(world.field_73012_v, CrystalChestContentsList, (IInventory)chest, 1 + world.field_73012_v.nextInt(5));
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  768 */           Block bid = world.func_147439_a(x + l1, y + l3, z + l2);
/*  769 */           if (bid == Blocks.field_150350_a) OreSpawnMain.setBlockFast(world, x + l1, y + l3, z + l2, OreSpawnMain.MyCrystalLeaves3, 0, 2);
/*      */         
/*      */         } 
/*      */       } 
/*      */     } 
...
/*  782 */           Block bid = world.func_147439_a(x + l1, y + l3, z + l2);
/*  783 */           if (bid == Blocks.field_150350_a) {
/*  784 */             if (l3 != 0) {
...
/*  804 */     int k = z;
/*      */     
/*  806 */     int grow = 4 + world.field_73012_v.nextInt(4);
...
/*  820 */       k2 = k;
/*      */     } 
/*  822 */     grow = 5 + world.field_73012_v.nextInt(5);
...
/*  833 */       k += zdir;
/*      */     } 
/*  835 */     grow = 5 + world.field_73012_v.nextInt(5);
...
/*      */     
/*  849 */     j2 = --j;
/*  850 */     grow = 4 + world.field_73012_v.nextInt(4);
...
/*  862 */       j += ydir;
/*      */     } 
/*  864 */     grow = 4 + world.field_73012_v.nextInt(4);
...
/*  883 */     int i = world.field_73012_v.nextInt(3);
/*      */     
/*  885 */     if (i == 1) {
/*      */       
/*  887 */       world.func_147465_d(x, y + 1, z, Blocks.field_150474_ac, 0, 2);
/*  888 */       TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(x, y + 1, z);
/*  889 */       if (tileentitymobspawner != null)
/*      */       {
/*  891 */         tileentitymobspawner.func_145881_a().func_98272_a("Fairy");
/*      */       }
/*      */     } 
/*  894 */     if (i == 2) {
/*  895 */       world.func_147465_d(x, y + 1, z, (Block)Blocks.field_150486_ae, 0, 2);
/*  896 */       TileEntityChest chest = (TileEntityChest)world.func_147438_o(x, y + 1, z);
/*  897 */       if (chest != null) {
/*      */ 
/*      */         
/*  900 */         this; WeightedRandomChestContent.func_76293_a(world.field_73012_v, CrystalChestContentsList, (IInventory)chest, 1 + world.field_73012_v.nextInt(5));
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  916 */       nc -= 2;
/*      */     }
/*  918 */     int j = 3 + world.field_73012_v.nextInt(3);
/*  919 */     int spread = 0;
/*      */     
/*  921 */     for (int iter = 0; iter < nc; iter++) {
/*  922 */       int grow = 4 + world.field_73012_v.nextInt(3);
/*  923 */       int width = 1 + world.field_73012_v.nextInt(3);
/*  924 */       int randy = world.field_73012_v.nextInt(3) - 1; int i;
...
/*      */       } 
/*  934 */       if (iter != 0) {
/*  935 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  936 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */           } 
/*      */         } 
/*  946 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  947 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */           } 
/*      */         } 
/*  957 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  958 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */       } 
/*  969 */       if (iter >= 2) {
/*  970 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  971 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */           } 
/*      */         } 
/*  981 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  982 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */           } 
/*      */         } 
/*  992 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/*  993 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/*      */           } 
/*      */         } 
/* 1003 */         width = 1 + world.field_73012_v.nextInt(3 + iter);
/* 1004 */         randy = world.field_73012_v.nextInt(3) - 1;
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\Trees.class
