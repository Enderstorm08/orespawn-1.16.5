...
/*  80 */     func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(OreSpawnMain.Godzilla_stats.health);
...
/*     */     
/* 135 */     List var5 = this.field_70170_p.func_72872_a(Godzilla.class, this.field_70121_D.func_72314_b(32.0D, 32.0D, 32.0D));
...
/*     */ 
/*     */       
/* 241 */       List var5 = this.field_70170_p.func_72872_a(Godzilla.class, this.field_70121_D.func_72314_b(32.0D, 32.0D, 32.0D));
...
/* 250 */         this.field_70163_u = var4.field_70163_u + 16.0D;
/* 251 */         this.field_70165_t = var4.field_70165_t - 17.0D * Math.sin(Math.toRadians(var4.field_70759_as));
/* 252 */         this.field_70161_v = var4.field_70161_v + 17.0D * Math.cos(Math.toRadians(var4.field_70759_as));
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\GodzillaHead.class
