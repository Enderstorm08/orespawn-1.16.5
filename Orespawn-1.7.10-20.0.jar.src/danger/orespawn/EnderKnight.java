...
/*  53 */     func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(OreSpawnMain.EnderKnight_stats.health);
/*  54 */     func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.32D);
/*  55 */     func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(OreSpawnMain.EnderKnight_stats.attack);
/*     */   }
/*     */ 
/*     */   
...
/*  87 */     EntityPlayer entityplayer = this.field_70170_p.func_72856_b((Entity)this, 64.0D);
/*     */     
...
/* 255 */     double d3 = this.field_70165_t;
/* 256 */     double d4 = this.field_70163_u;
/* 257 */     double d5 = this.field_70161_v;
/* 258 */     this.field_70165_t = par1;
/* 259 */     this.field_70163_u = par3;
/* 260 */     this.field_70161_v = par5;
/* 261 */     boolean flag = false;
/* 262 */     int i = MathHelper.func_76128_c(this.field_70165_t);
/* 263 */     int j = MathHelper.func_76128_c(this.field_70163_u);
/* 264 */     int k = MathHelper.func_76128_c(this.field_70161_v);
/*     */ 
/*     */     
/* 267 */     if (this.field_70170_p.func_72899_e(i, j, k)) {
/*     */       
/* 269 */       boolean flag1 = false;
/*     */       
/* 271 */       while (!flag1 && j > 0) {
/*     */         
/* 273 */         Block l = this.field_70170_p.func_147439_a(i, j - 1, k);
/*     */         
/* 275 */         if (l != Blocks.field_150350_a && l.func_149688_o().func_76230_c()) {
/*     */           
/* 277 */           flag1 = true;
/*     */           
/*     */           continue;
/*     */         } 
/* 281 */         this.field_70163_u--;
/* 282 */         j--;
/*     */       } 
/*     */ 
/*     */       
/* 286 */       if (flag1) {
/*     */         
/* 288 */         func_70107_b(this.field_70165_t, this.field_70163_u, this.field_70161_v);
/*     */         
/* 290 */         if (this.field_70170_p.func_72945_a((Entity)this, this.field_70121_D).isEmpty() && !this.field_70170_p.func_72953_d(this.field_70121_D))
/*     */         {
/* 292 */           flag = true;
/*     */         }
/*     */       } 
...
/* 309 */       float f = (this.field_70146_Z.nextFloat() - 0.5F) * 0.2F;
/* 310 */       float f1 = (this.field_70146_Z.nextFloat() - 0.5F) * 0.2F;
/* 311 */       float f2 = (this.field_70146_Z.nextFloat() - 0.5F) * 0.2F;
/* 312 */       double d7 = d3 + (this.field_70165_t - d3) * d6 + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N * 2.0D;
/* 313 */       double d8 = d4 + (this.field_70163_u - d4) * d6 + this.field_70146_Z.nextDouble() * this.field_70131_O;
/* 314 */       double d9 = d5 + (this.field_70161_v - d5) * d6 + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N * 2.0D;
/* 315 */       this.field_70170_p.func_72869_a("portal", d7, d8, d9, f, f1, f2);
/*     */     } 
/*     */     
/* 318 */     this.field_70170_p.func_72908_a(d3, d4, d5, "mob.endermen.portal", 1.0F, 1.0F);
/* 319 */     func_85030_a("mob.endermen.portal", 1.0F, 1.0F);
/* 320 */     return true;
/*     */   }
/*     */ 
/*     */ 
...
/* 361 */     if (this.field_70170_p.field_73012_v.nextInt(2) == 1) return Items.field_151061_bv; 
/* 362 */     return Items.field_151079_bi;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       } 
/*     */       
/* 411 */       return super.func_70097_a(par1DamageSource, par2);
/*     */     } 
/*     */ 
/*     */     
/* 415 */     return super.func_70097_a(par1DamageSource, par2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */           
/* 432 */           Block bid = this.field_70170_p.func_147439_a((int)this.field_70165_t + j, (int)this.field_70163_u + i, (int)this.field_70161_v + k);
/* 433 */           if (bid == Blocks.field_150474_ac) {
/* 434 */             TileEntityMobSpawner tileentitymobspawner = null;
/* 435 */             tileentitymobspawner = (TileEntityMobSpawner)this.field_70170_p.func_147438_o((int)this.field_70165_t + j, (int)this.field_70163_u + i, (int)this.field_70161_v + k);
/* 436 */             String s = tileentitymobspawner.func_145881_a().func_98276_e();
/* 437 */             if (s != null && 
...
/*     */     } 
/*     */     
/* 446 */     if (!func_70814_o()) return false; 
/* 447 */     if (this.field_70170_p.func_72935_r() == true) return false; 
/* 448 */     if (this.field_70163_u < 30.0D) return false; 
/* 449 */     return true;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isScreaming() {
/* 454 */     return (this.field_70180_af.func_75683_a(18) > 0);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setScreaming(boolean par1) {
/* 459 */     this.field_70180_af.func_75692_b(18, Byte.valueOf((byte)(par1 ? 1 : 0)));
/*     */   }
/*     */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\EnderKnight.class
