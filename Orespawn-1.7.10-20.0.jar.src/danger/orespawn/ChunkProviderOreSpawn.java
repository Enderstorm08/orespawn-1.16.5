...
/* 121 */     this.field_147435_p = par1World.func_72912_H().func_76067_t();
...
/*     */         
/* 137 */         float f = 10.0F / MathHelper.func_76129_c((j * j + k * k) + 0.2F);
...
/* 155 */     byte b0 = 63;
/* 156 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76937_a(this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
...
/* 202 */                 if ((d15 += d16) > 0.0D) {
/*     */                   
/* 204 */                   p_147424_3_[j3 += short1] = Blocks.field_150348_b;
/*     */                 }
/* 206 */                 else if (k2 * 8 + l2 < b0) {
/*     */                   
/* 208 */                   p_147424_3_[j3 += short1] = Blocks.field_150355_j;
/*     */                 }
/*     */                 else {
/*     */                   
...
/* 237 */     this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (p_147422_1_ * 16), (p_147422_2_ * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
/*     */     
...
/* 244 */         biomegenbase.func_150573_a(this.worldObj, this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k, p_147422_2_ * 16 + l, this.stoneNoise[l + k * 16]);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 254 */     return func_73154_d(par1, par2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 304 */     this.field_147426_g = this.noiseGen6.func_76305_a(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
/* 305 */     this.field_147427_d = this.field_147429_l.func_76304_a(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
/* 306 */     this.field_147428_e = this.field_147431_j.func_76304_a(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
/* 307 */     this.field_147425_f = this.field_147432_k.func_76304_a(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
...
/* 329 */             float f3 = biomegenbase1.field_76748_D;
/* 330 */             float f4 = biomegenbase1.field_76749_E;
/*     */             
/* 332 */             if (this.field_147435_p == WorldType.field_151360_e && f3 > 0.0F) {
/*     */               
/* 334 */               f3 = 1.0F + f3 * 2.0F;
/* 335 */               f4 = 1.0F + f4 * 4.0F;
/*     */             } 
...
/*     */             
/* 340 */             if (biomegenbase1.field_76748_D > biomegenbase.field_76748_D)
/*     */             {
/* 342 */               f5 /= 2.0F;
/*     */             }
/*     */             
...
/* 405 */           double d10 = MathHelper.func_151238_b(d7, d8, d9) - d6;
/*     */           
/* 407 */           if (j2 > 29) {
/*     */             
...
/* 434 */     BlockFalling.field_149832_M = false;
/* 435 */     int k = par2 * 16;
/* 436 */     int l = par3 * 16;
/* 437 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(k + 16, l + 16);
/* 438 */     this.rand.setSeed(this.worldObj.func_72905_C());
/* 439 */     long i1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 440 */     long j1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 441 */     this.rand.setSeed(par2 * i1 + par3 * j1 ^ this.worldObj.func_72905_C());
...
/*     */ 
/*     */     
/* 490 */     biomegenbase.func_76728_a(this.worldObj, this.rand, k, l);
/*     */ 
/*     */     
/* 493 */     SpawnerAnimals.func_77191_a(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 532 */     BlockFalling.field_149832_M = false;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 587 */     var5 = this.worldObj.func_72807_a(par2, par4);
/*     */     
/* 589 */     if (var5 == null) return null;
/*     */     
/* 591 */     l = var5.func_76747_a(par1EnumCreatureType);
...
/*     */           
/* 611 */           var3 = var2.next();
/* 612 */           if (var3.field_76300_b == EntityHorse.class) {
/*     */             continue;
/*     */           }
/*     */           
...
/*     */       
/* 630 */       var3 = var2.next();
/* 631 */       if (var3 != null && var3.field_76300_b != EntityHorse.class) {
/* 632 */         m.add(var3);
/*     */       }
/*     */     } 
/* 635 */     return m;
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkProviderOreSpawn.class
