...
/*  33 */     if (world.field_73012_v.nextInt(20) == 1) {
/*  34 */       FastSetBlock(world, cposx, cposy, cposz, OreSpawnMain.MyOreRubyBlock);
/*  35 */     } else if (world.field_73012_v.nextInt(2) == 1) {
/*  36 */       FastSetBlock(world, cposx, cposy, cposz, Blocks.field_150341_Y);
/*     */     } else {
/*  38 */       FastSetBlock(world, cposx, cposy, cposz, Blocks.field_150347_e);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*  52 */           FastSetBlock(world, cposx + i, cposy + j, cposz + m, Blocks.field_150350_a);
/*     */         }
/*     */       } 
/*     */     } 
/*     */ 
...
/*  61 */         FastSetBlock(world, cposx + i, cposy + j, cposz + m, Blocks.field_150341_Y);
/*     */       }
/*     */     } 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/*  94 */     world.func_147465_d(cposx + width / 2, cposy + 1, cposz + width / 2, Blocks.field_150474_ac, 0, 2);
/*  95 */     TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(cposx + width / 2, cposy + 1, cposz + width / 2);
/*     */     
/*  97 */     if (tileentitymobspawner != null)
/*     */     {
/*  99 */       tileentitymobspawner.func_145881_a().func_98272_a("Ruby Bird");
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/* 106 */     world.func_147465_d(cposx + width / 2, cposy + 1, cposz + 1, (Block)Blocks.field_150486_ae, 0, 2);
/* 107 */     chest = (TileEntityChest)world.func_147438_o(cposx + width / 2, cposy + 1, cposz + 1);
/* 108 */     if (chest != null)
/*     */     {
/*     */       
/* 111 */       WeightedRandomChestContent.func_76293_a(world.field_73012_v, this.chestContentsList, (IInventory)chest, 4 + world.field_73012_v.nextInt(7));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\RubyBirdDungeon.class
