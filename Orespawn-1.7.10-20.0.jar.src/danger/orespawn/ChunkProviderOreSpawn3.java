...
/* 100 */     this.field_147435_p = par1World.func_72912_H().func_76067_t();
...
/*     */         
/* 116 */         float f = 10.0F / MathHelper.func_76129_c((j * j + k * k) + 0.2F);
...
/* 134 */     byte b0 = 63;
/* 135 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76937_a(this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
...
/* 181 */                 if ((d15 += d16) > 0.0D) {
/*     */                   
/* 183 */                   p_147424_3_[j3 += short1] = Blocks.field_150348_b;
/*     */                 }
/* 185 */                 else if (k2 * 8 + l2 < b0) {
/*     */                   
/* 187 */                   p_147424_3_[j3 += short1] = Blocks.field_150355_j;
/*     */                 }
/*     */                 else {
/*     */                   
...
/* 216 */     this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (p_147422_1_ * 16), (p_147422_2_ * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
/*     */     
...
/* 223 */         biomegenbase.func_150573_a(this.worldObj, this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k, p_147422_2_ * 16 + l, this.stoneNoise[l + k * 16]);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 233 */     return func_73154_d(par1, par2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 246 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76933_b(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
...
/* 273 */     this.field_147426_g = this.noiseGen6.func_76305_a(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
/* 274 */     this.field_147427_d = this.field_147429_l.func_76304_a(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
/* 275 */     this.field_147428_e = this.field_147431_j.func_76304_a(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
/* 276 */     this.field_147425_f = this.field_147432_k.func_76304_a(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
...
/* 298 */             float f3 = biomegenbase1.field_76748_D;
/* 299 */             float f4 = biomegenbase1.field_76749_E;
/*     */             
/* 301 */             if (this.field_147435_p == WorldType.field_151360_e && f3 > 0.0F) {
/*     */               
/* 303 */               f3 = 1.0F + f3 * 2.0F;
/* 304 */               f4 = 1.0F + f4 * 4.0F;
/*     */             } 
...
/*     */             
/* 309 */             if (biomegenbase1.field_76748_D > biomegenbase.field_76748_D)
/*     */             {
/* 311 */               f5 /= 2.0F;
/*     */             }
/*     */             
...
/* 374 */           double d10 = MathHelper.func_151238_b(d7, d8, d9) - d6;
/*     */           
/* 376 */           if (j2 > 29) {
/*     */             
...
/* 402 */     BlockFalling.field_149832_M = true;
/* 403 */     int k = par2 * 16;
/* 404 */     int l = par3 * 16;
/* 405 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(k + 16, l + 16);
/* 406 */     this.rand.setSeed(this.worldObj.func_72905_C());
/* 407 */     long i1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 408 */     long j1 = this.rand.nextLong() / 2L * 2L + 1L;
/* 409 */     this.rand.setSeed(par2 * i1 + par3 * j1 ^ this.worldObj.func_72905_C());
...
/*     */       
/* 416 */       this.mineshaftGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/* 417 */       flag = this.villageGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/* 418 */       this.strongholdGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/* 419 */       this.scatteredFeatureGenerator.func_75051_a(this.worldObj, this.rand, par2, par3);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 426 */     if (biomegenbase != BiomeGenBase.field_76769_d && biomegenbase != BiomeGenBase.field_76786_s && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAKE)) {
/*     */ 
/*     */       
/* 429 */       int i = k + this.rand.nextInt(16) + 8;
/* 430 */       int l1 = this.rand.nextInt(256);
/* 431 */       int i2 = l + this.rand.nextInt(16) + 8;
/* 432 */       (new WorldGenLakes(Blocks.field_150355_j)).func_76484_a(this.worldObj, this.rand, i, l1, i2);
/*     */     } 
/*     */     
...
/*     */       {
/* 443 */         (new WorldGenLakes(Blocks.field_150353_l)).func_76484_a(this.worldObj, this.rand, i, l1, i2);
/*     */       }
/*     */     } 
/*     */     
...
/* 453 */       (new WorldGenDungeons()).func_76484_a(this.worldObj, this.rand, l1, i2, j2);
/*     */     } 
/*     */     
/* 456 */     biomegenbase.func_76728_a(this.worldObj, this.rand, k, l);
/* 457 */     SpawnerAnimals.func_77191_a(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
/* 458 */     k += 8;
/* 459 */     l += 8;
/*     */     
...
/*     */         
/* 466 */         int i2 = this.worldObj.func_72874_g(k + k1, l + l1);
/*     */         
/* 468 */         if (this.worldObj.func_72884_u(k1 + k, i2 - 1, l1 + l))
/*     */         {
/* 470 */           this.worldObj.func_147465_d(k1 + k, i2 - 1, l1 + l, Blocks.field_150432_aD, 0, 2);
/*     */         }
/*     */         
/* 473 */         if (this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true))
/*     */         {
/* 475 */           this.worldObj.func_147465_d(k1 + k, i2, l1 + l, Blocks.field_150431_aC, 0, 2);
/*     */         }
/*     */       } 
/*     */     } 
/*     */ 
/*     */ 
/*     */     
/* 482 */     BlockFalling.field_149832_M = false;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 529 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(par2, par4);
/* 530 */     return (par1EnumCreatureType == EnumCreatureType.monster && this.scatteredFeatureGenerator.func_143030_a(par2, par3, par4)) ? this.scatteredFeatureGenerator.func_82667_a() : biomegenbase.func_76747_a(par1EnumCreatureType);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkProviderOreSpawn3.class
