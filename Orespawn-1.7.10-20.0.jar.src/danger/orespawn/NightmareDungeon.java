...
/*  51 */     if (world.field_73012_v.nextInt(2) == 1) {
/*  52 */       FastSetBlock(world, cposx, cposy, cposz, Blocks.field_150357_h);
/*     */     } else {
/*  54 */       FastSetBlock(world, cposx, cposy, cposz, Blocks.field_150343_Z);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*  68 */           FastSetBlock(world, cposx + i, cposy + j, cposz + m, Blocks.field_150350_a);
/*     */         }
/*     */       } 
/*     */     } 
/*     */ 
...
/*  85 */         FastSetBlock(world, cposx + i, cposy + j, cposz + m, Blocks.field_150357_h);
/*     */       }
/*     */     } 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 110 */     world.func_147465_d(cposx + width / 2, cposy + 1, cposz + width / 2, Blocks.field_150474_ac, 0, 2);
/* 111 */     TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(cposx + width / 2, cposy + 1, cposz + width / 2);
/*     */     
/* 113 */     if (tileentitymobspawner != null)
/*     */     {
/* 115 */       if (world.field_73012_v.nextInt(2) == 1) {
/* 116 */         tileentitymobspawner.func_145881_a().func_98272_a("Emperor Scorpion");
/*     */       } else {
/* 118 */         tileentitymobspawner.func_145881_a().func_98272_a("Nightmare");
/*     */       } 
/*     */     }
/*     */ 
/*     */ 
...
/*     */     
/* 126 */     world.func_147465_d(cposx + width / 2 + 1, cposy + 1, cposz + width / 2 + 1, (Block)Blocks.field_150486_ae, 0, 2);
/* 127 */     chest = (TileEntityChest)world.func_147438_o(cposx + width / 2 + 1, cposy + 1, cposz + width / 2 + 1);
/* 128 */     if (chest != null)
/*     */     {
/*     */       
/* 131 */       WeightedRandomChestContent.func_76293_a(world.field_73012_v, this.chestContentsList, (IInventory)chest, 4 + world.field_73012_v.nextInt(7));
/*     */     }
/* 133 */     world.func_147465_d(cposx + width / 2 - 1, cposy + 1, cposz + width / 2 - 1, (Block)Blocks.field_150486_ae, 0, 2);
/* 134 */     chest = (TileEntityChest)world.func_147438_o(cposx + width / 2 - 1, cposy + 1, cposz + width / 2 - 1);
/* 135 */     if (chest != null)
/*     */     {
/*     */       
/* 138 */       WeightedRandomChestContent.func_76293_a(world.field_73012_v, this.chestContentsList, (IInventory)chest, 4 + world.field_73012_v.nextInt(7));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\NightmareDungeon.class
