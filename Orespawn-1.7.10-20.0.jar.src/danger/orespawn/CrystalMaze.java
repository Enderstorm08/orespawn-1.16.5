...
/*  33 */           OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x + j, y + k, z + i, Blocks.field_150350_a, 0);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/*  48 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx, yy, zz + i, Blocks.field_150350_a, 0);
/*  49 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx, yy + 1, zz + i, Blocks.field_150350_a, 0);
/*  50 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx, yy + 2, zz + i, Blocks.field_150350_a, 0);
/*  51 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy, zz, Blocks.field_150350_a, 0);
/*  52 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy + 1, zz, Blocks.field_150350_a, 0);
/*  53 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy + 2, zz, Blocks.field_150350_a, 0);
/*  54 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + zw * csz - 1, yy, zz + i, Blocks.field_150350_a, 0);
/*  55 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + zw * csz - 1, yy + 1, zz + i, Blocks.field_150350_a, 0);
/*  56 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + zw * csz - 1, yy + 2, zz + i, Blocks.field_150350_a, 0);
/*  57 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy, zz + zw * csz - 1, Blocks.field_150350_a, 0);
/*  58 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy + 1, zz + zw * csz - 1, Blocks.field_150350_a, 0);
/*  59 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + i, yy + 2, zz + zw * csz - 1, Blocks.field_150350_a, 0);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/*  66 */         OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + m, yy - 1, zz + i, Blocks.field_150357_h, 0);
/*  67 */         OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + m, yy + 3, zz + i, Blocks.field_150357_h, 0);
/*     */       } 
/*     */     } 
/*     */     
/*  71 */     for (int k = 0; k < 4; k++) {
/*  72 */       i = world.field_73012_v.nextInt(zw * csz);
/*  73 */       int m = world.field_73012_v.nextInt(zw * csz);
/*  74 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, xx + m, yy + 3, zz + i, OreSpawnMain.CrystalStone, 0);
/*     */     } 
/*  76 */     i = world.field_73012_v.nextInt(zw * csz);
/*  77 */     int j = world.field_73012_v.nextInt(zw * csz);
...
/* 175 */     Block blk = Blocks.field_150343_Z;
/* 176 */     if (bb != 0) blk = Blocks.field_150357_h; 
/* 177 */     if (fromx > tox) {
/* 178 */       int i = fromx;
/* 179 */       fromx = tox;
/* 180 */       tox = i;
...
/* 341 */           OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x + i, y + j, z + k, Blocks.field_150350_a, 0);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 349 */           OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x - i, y + j, z + k, Blocks.field_150350_a, 0); 
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\CrystalMaze.class
