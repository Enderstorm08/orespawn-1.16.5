...
/*  27 */     int depth = 20 + world.field_73012_v.nextInt(10);
...
/* 131 */     Block blk = Blocks.field_150343_Z;
/* 132 */     if (bb != 0) blk = Blocks.field_150357_h; 
/* 133 */     if (fromx > tox) {
/* 134 */       int i = fromx;
/* 135 */       fromx = tox;
/* 136 */       tox = i;
...
/*     */ 
/*     */     
/* 290 */     var8 = EntityList.func_75620_a(par1, par0World);
/*     */     
/* 292 */     if (var8 != null) {
/*     */ 
/*     */       
/* 295 */       var8.func_70012_b(par2, par4, par6, par0World.field_73012_v.nextFloat() * 360.0F, 0.0F);
/*     */ 
/*     */       
/* 298 */       par0World.func_72838_d(var8);
/*     */       
/* 300 */       ((EntityLiving)var8).func_70642_aH();
/*     */     } 
/*     */     
/* 303 */     return var8;
/*     */   }
...
/* 317 */           OreSpawnMain.setBlockFast(world, x + i, y + j, z + k, Blocks.field_150350_a, 0, 2);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 325 */           OreSpawnMain.setBlockFast(world, x - i, y + j, z + k, Blocks.field_150350_a, 0, 2); 
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 333 */       Block bid = world.func_147439_a(xx + 1, yy, zz + i);
/* 334 */       if (bid == Blocks.field_150350_a) {
/* 335 */         OreSpawnMain.setBlockFast(world, xx, yy, zz + i, Blocks.field_150350_a, 0, 2);
/* 336 */         OreSpawnMain.setBlockFast(world, xx, yy + 1, zz + i, Blocks.field_150350_a, 0, 2);
/* 337 */         OreSpawnMain.setBlockFast(world, xx, yy + 2, zz + i, Blocks.field_150350_a, 0, 2);
/*     */         
/*     */         break;
/*     */       } 
/*     */     } 
/* 342 */     for (i = zw * csz - 1; i >= 0; i--) {
/* 343 */       Block bid = world.func_147439_a(xx + xw * csz - 2, yy, zz + i);
/* 344 */       if (bid == Blocks.field_150350_a) {
/* 345 */         OreSpawnMain.setBlockFast(world, xx + xw * csz - 1, yy, zz + i, Blocks.field_150350_a, 0, 2);
/* 346 */         OreSpawnMain.setBlockFast(world, xx + xw * csz - 1, yy + 1, zz + i, Blocks.field_150350_a, 0, 2);
/* 347 */         OreSpawnMain.setBlockFast(world, xx + xw * csz - 1, yy + 2, zz + i, Blocks.field_150350_a, 0, 2);
/*     */         break;
/*     */       } 
/*     */     } 
/*     */   }
...
/* 395 */         OreSpawnMain.setBlockFast(world, x + i, y, z + j, Blocks.field_150343_Z, 0, 2);
/*     */       }
/*     */     } 
/* 398 */     for (i = 0; i < 80; i++) {
/* 399 */       OreSpawnMain.setBlockFast(world, x + world.field_73012_v.nextInt(28) + 1, y, z + world.field_73012_v.nextInt(28) + 1, Blocks.field_150353_l, 0, 2);
/*     */     }
/*     */ 
/*     */     
/* 403 */     for (i = 0; i < 20; i++) {
/* 404 */       OreSpawnMain.setBlockFast(world, x + 30 + world.field_73012_v.nextInt(28) + 1, y, z + world.field_73012_v.nextInt(28) + 1, OreSpawnMain.MyRTPBlock, 0, 2);
/*     */     }
/*     */ 
/*     */     
/* 408 */     for (i = 0; i < 30; i++) {
/* 409 */       for (int j = 0; j < 30; j++) {
/* 410 */         OreSpawnMain.setBlockFast(world, x + i, y + 4, z + j, Blocks.field_150357_h, 0, 2);
/*     */       }
/*     */     } 
/* 413 */     for (i = 0; i < 30; i++) {
/* 414 */       for (int j = 0; j < 30; j++) {
/* 415 */         OreSpawnMain.setBlockFast(world, x + i + 30, y + 6, z + j, Blocks.field_150357_h, 0, 2);
/*     */       }
/*     */     } 
/* 418 */     for (i = 0; i < 30; i++) {
/* 419 */       for (int j = 0; j < 5; j++) {
/* 420 */         OreSpawnMain.setBlockFast(world, x + 59, y + j + 1, z + i, Blocks.field_150343_Z, 0, 2);
/* 421 */         OreSpawnMain.setBlockFast(world, x + 60, y + j + 1, z + i, Blocks.field_150357_h, 0, 2);
/* 422 */         OreSpawnMain.setBlockFast(world, x + 61, y + j + 1, z + i, Blocks.field_150357_h, 0, 2);
/*     */       } 
/* 424 */     }  for (i = 0; i < 30; i++) {
/* 425 */       for (int j = 0; j < 5; j++) {
/* 426 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z, Blocks.field_150343_Z, 0, 2);
/* 427 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z - 1, Blocks.field_150357_h, 0, 2);
/* 428 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z - 2, Blocks.field_150357_h, 0, 2);
/*     */       } 
/* 430 */     }  for (i = 0; i < 30; i++) {
/* 431 */       for (int j = 0; j < 5; j++) {
/* 432 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z + 29, Blocks.field_150343_Z, 0, 2);
/* 433 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z + 30, Blocks.field_150357_h, 0, 2);
/* 434 */         OreSpawnMain.setBlockFast(world, x + 30 + i, y + j + 1, z + 31, Blocks.field_150357_h, 0, 2);
/*     */       } 
/*     */     } 
/* 437 */     for (i = 0; i < 30; i++) {
/* 438 */       OreSpawnMain.setBlockFast(world, x + 30, y + 5, z + i, Blocks.field_150343_Z, 0, 2);
/*     */     }
/*     */     
/* 441 */     for (i = 0; i < 30; i++) {
/* 442 */       for (int j = 0; j < 4; j++)
/* 443 */         OreSpawnMain.setBlockFast(world, x - 4 + j, y, z + i, Blocks.field_150322_A, 0, 2); 
/*     */     } 
/* 445 */     for (i = 0; i < 30; i++) {
/* 446 */       for (int j = 0; j < 4; j++)
/* 447 */         OreSpawnMain.setBlockFast(world, x - 4 + j, y + 5, z + i, Blocks.field_150343_Z, 0, 2); 
/*     */     } 
/* 449 */     for (i = 0; i < 30; i++) {
/* 450 */       for (int j = 1; j < 5; j++)
/* 451 */         OreSpawnMain.setBlockFast(world, x - 5, y + j, z + i, Blocks.field_150366_p, 0, 2); 
/* 452 */     }  for (i = 0; i < 5; i++) {
/* 453 */       for (int j = 1; j < 5; j++)
/* 454 */         OreSpawnMain.setBlockFast(world, x - 4 + i, y + j, z - 1, Blocks.field_150366_p, 0, 2); 
/* 455 */     }  for (i = 0; i < 5; i++) {
/* 456 */       for (int j = 1; j < 5; j++) {
/* 457 */         OreSpawnMain.setBlockFast(world, x - 4 + i, y + j, z + 30, Blocks.field_150366_p, 0, 2);
/*     */       }
/*     */     } 
/*     */     int k;
/* 461 */     for (k = 0; k < 4; k++)
/* 462 */       OreSpawnMain.setBlockFast(world, x - 4, y + 1 + k, z, Blocks.field_150322_A, 0, 2); 
/* 463 */     for (k = 0; k < 4; k++)
/* 464 */       OreSpawnMain.setBlockFast(world, x - 4, y + 1 + k, z + 15, Blocks.field_150322_A, 0, 2); 
/* 465 */     for (k = 0; k < 4; k++) {
/* 466 */       OreSpawnMain.setBlockFast(world, x - 4, y + 1 + k, z + 29, Blocks.field_150322_A, 0, 2);
/*     */     }
...
/*     */     
/* 472 */     OreSpawnMain.setBlockFast(world, x + 30, y + 4, z + 2, Blocks.field_150429_aA, 0, 2);
/* 473 */     OreSpawnMain.setBlockFast(world, x + 30, y + 4, z + 15, Blocks.field_150429_aA, 0, 2);
/* 474 */     OreSpawnMain.setBlockFast(world, x + 30, y + 4, z + 27, Blocks.field_150429_aA, 0, 2);
/*     */ 
/*     */     
/* 477 */     TileEntityChest chest = null;
/* 478 */     i = 2 + world.field_73012_v.nextInt(3);
/* 479 */     for (k = 0; k < i; k++) {
/* 480 */       OreSpawnMain.setBlockFast(world, x + 58, y + 4, z + 2 + k * 2, Blocks.field_150478_aa, 0, 2);
/* 481 */       OreSpawnMain.setBlockFast(world, x + 58, y + 1, z + 2 + k * 2, (Block)Blocks.field_150486_ae, 0, 2);
/* 482 */       chest = (TileEntityChest)world.func_147438_o(x + 58, y + 1, z + 2 + k * 2);
/* 483 */       if (chest != null)
/*     */       {
/*     */         
/* 486 */         WeightedRandomChestContent.func_76293_a(world.field_73012_v, this.chestContentsList, (IInventory)chest, 5 + world.field_73012_v.nextInt(6));
/*     */       }
/*     */     } 
/*     */ 
/*     */ 
...
/* 518 */         OreSpawnMain.setBlockFast(world, x + i - j, y + width - j, z - j, Blocks.field_150322_A, 0, 2);
/* 519 */         OreSpawnMain.setBlockFast(world, x + i - j, y + width - j, z + j + 3, Blocks.field_150322_A, 0, 2);
/* 520 */         OreSpawnMain.setBlockFast(world, x - j, y + width - j, z + i - j, Blocks.field_150322_A, 0, 2);
/* 521 */         OreSpawnMain.setBlockFast(world, x + j + 3, y + width - j, z + i - j, Blocks.field_150322_A, 0, 2);
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/* 529 */         OreSpawnMain.setBlockFast(world, x + i, y + j, z, Blocks.field_150357_h, 0, 2);
/* 530 */         OreSpawnMain.setBlockFast(world, x + i, y + j, z + 3, Blocks.field_150357_h, 0, 2);
/* 531 */         OreSpawnMain.setBlockFast(world, x, y + j, z + i, Blocks.field_150357_h, 0, 2);
/* 532 */         OreSpawnMain.setBlockFast(world, x + 3, y + j, z + i, Blocks.field_150357_h, 0, 2);
/*     */       } 
/*     */ 
/*     */       
/* 536 */       for (int l = 0; l < 2; l++) {
/* 537 */         for (int m = 0; m < 2; m++) {
/* 538 */           OreSpawnMain.setBlockFast(world, x + 1 + l, y + j, z + 1 + m, Blocks.field_150350_a, 0, 2);
/*     */         }
/*     */       } 
/* 541 */       switch (k) {
/*     */         case 0:
/* 543 */           OreSpawnMain.setBlockFast(world, x + 1, y + j, z + 1, Blocks.field_150343_Z, 0, 2);
/*     */           break;
/*     */         case 1:
/* 546 */           OreSpawnMain.setBlockFast(world, x + 2, y + j, z + 1, Blocks.field_150343_Z, 0, 2);
/*     */           break;
/*     */         case 2:
/* 549 */           OreSpawnMain.setBlockFast(world, x + 2, y + j, z + 2, Blocks.field_150343_Z, 0, 2);
/*     */           break;
/*     */         default:
/* 552 */           OreSpawnMain.setBlockFast(world, x + 1, y + j, z + 2, Blocks.field_150343_Z, 0, 2);
/*     */           break;
/*     */       } 
/* 555 */       k++;
/* 556 */       if (k > 3) k = 0; 
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\BasiliskMaze.class
