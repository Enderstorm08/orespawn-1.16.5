...
/*     */ 
/*     */     
/* 119 */     Block block = Blocks.field_150348_b;
/*     */     
...
/*     */                 
/* 157 */                 block = Blocks.field_150348_b;
/*     */ 
/*     */                 
/* 160 */                 if (d15 > 0.0D)
/*     */                 {
...
/* 191 */     this.slowsandNoise = this.slowsandGravelNoiseGen.func_76304_a(this.slowsandNoise, p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, d0, d0, 1.0D);
/* 192 */     this.gravelNoise = this.slowsandGravelNoiseGen.func_76304_a(this.gravelNoise, p_147418_1_ * 16, 109, p_147418_2_ * 16, 16, 1, 16, d0, 1.0D, d0);
/* 193 */     this.netherrackExclusivityNoise = this.netherrackExculsivityNoiseGen.func_76304_a(this.netherrackExclusivityNoise, p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, d0 * 2.0D, d0 * 2.0D, d0 * 2.0D);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 209 */         int j1 = -1;
/* 210 */         BlockGrass blockGrass = Blocks.field_150349_c;
/* 211 */         Block block1 = Blocks.field_150346_d;
/*     */         
...
/*     */             
/* 221 */             if (block2 != null && block2.func_149688_o() != Material.field_151579_a) {
/*     */               
/* 223 */               if (block2 == Blocks.field_150348_b)
/*     */               {
/* 225 */                 if (j1 == -1) {
...
/*     */                     
/* 229 */                     blockGrass = null;
/* 230 */                     block1 = Blocks.field_150348_b;
/*     */                   }
/* 232 */                   else if (k1 >= b0 - 4 && k1 <= b0 + 1) {
/*     */                     
/* 234 */                     block = Blocks.field_150348_b;
/* 235 */                     block1 = Blocks.field_150348_b;
/*     */                     
/* 237 */                     if (flag1) {
/*     */                       
/* 239 */                       blockGrass1 = Blocks.field_150349_c;
/* 240 */                       block1 = Blocks.field_150346_d;
/*     */                     } 
/*     */                     
/* 243 */                     if (flag) {
/*     */                       
/* 245 */                       blockGrass1 = Blocks.field_150349_c;
/* 246 */                       block1 = Blocks.field_150346_d;
/*     */                     } 
/*     */                   } 
/*     */                   
/* 250 */                   if (k1 < b0 && blockGrass1 == Blocks.field_150350_a)
/*     */                   {
/* 252 */                     block = Blocks.field_150355_j;
/*     */                   }
/*     */                   
/* 255 */                   j1 = i1;
/*     */                   
...
/* 292 */     return func_73154_d(p_73158_1_, p_73158_2_);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 310 */     OreSpawnMain.Chunker.generateOresInChunk(this.worldObj, this.worldObj.field_73012_v, p_73154_1_ * 16, p_73154_2_ * 16, chunk);
/* 311 */     addScragglyTrees(this.worldObj, p_73154_1_ * 16, p_73154_2_ * 16, chunk);
/*     */     
/* 313 */     chunk.func_76603_b();
/* 314 */     return chunk;
/*     */   }
/*     */ 
/*     */ 
...
/* 348 */     this.noiseData4 = this.netherNoiseGen6.func_76304_a(this.noiseData4, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, 1, p_73164_7_, 1.0D, 0.0D, 1.0D);
/* 349 */     this.noiseData5 = this.netherNoiseGen7.func_76304_a(this.noiseData5, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, 1, p_73164_7_, 100.0D, 0.0D, 100.0D);
/* 350 */     this.noiseData1 = this.netherNoiseGen3.func_76304_a(this.noiseData1, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0 / 80.0D, d1 / 60.0D, d0 / 80.0D);
/* 351 */     this.noiseData2 = this.netherNoiseGen1.func_76304_a(this.noiseData2, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0, d1, d0);
/* 352 */     this.noiseData3 = this.netherNoiseGen2.func_76304_a(this.noiseData3, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0, d1, d0);
/*     */     
/*     */     int i2;
...
/* 489 */     BlockFalling.field_149832_M = false;
/*     */ 
/*     */     
/* 492 */     int var4 = par2 * 16;
/* 493 */     int var5 = par3 * 16;
/* 494 */     BiomeGenBase var6 = this.worldObj.func_72807_a(var4 + 16, var5 + 16);
/*     */     
/* 496 */     var6.func_76728_a(this.worldObj, this.worldObj.field_73012_v, var4, var5);
/*     */     
/* 498 */     SpawnerAnimals.func_77191_a(this.worldObj, var6, var4 + 8, var5 + 8, 16, 16, this.worldObj.field_73012_v);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 547 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(p_73155_2_, p_73155_4_);
/* 548 */     return biomegenbase.func_76747_a(p_73155_1_);
/*     */   }
/*     */ 
/*     */   
...
/* 570 */     int howmany = 1 + world.field_73012_v.nextInt(5);
/* 571 */     if (world.field_73012_v.nextInt(4) != 0) {
/*     */       return;
/*     */     }
/*     */     
...
/*     */         
/* 588 */         if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == Blocks.field_150349_c) {
/*     */           
...
/* 615 */       if (bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*     */         return;
/*     */       }
/* 618 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x, y, z, Blocks.field_150364_r, 0);
/*     */       
...
/* 624 */             if (bid == Blocks.field_150350_a) {
...
/* 632 */         if (bid == Blocks.field_150350_a) {
...
/* 654 */       if (k >= 1 && bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*     */         return;
/*     */       }
/* 657 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x, y + k, z, Blocks.field_150364_r, 0);
/*     */     } 
/* 659 */     y += i - 1;
/*     */     
/* 661 */     for (k = i; k < j; k++) {
...
/* 669 */       if (bid != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
/*     */         break;
/*     */       }
/* 672 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x, y, z, Blocks.field_150364_r, 0);
...
/* 681 */             if (bid == Blocks.field_150350_a) {
...
/* 689 */         if (bid == Blocks.field_150350_a)
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkProviderOreSpawn6.class
