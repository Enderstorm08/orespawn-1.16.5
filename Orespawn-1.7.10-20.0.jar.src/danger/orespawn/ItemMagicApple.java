...
/*   91 */     this.field_77777_bU = 1;
/*   92 */     func_77637_a(CreativeTabs.field_78031_c);
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public void func_77622_d(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
/*   98 */     par1ItemStack.func_77966_a(Enchantment.field_77346_s, 2);
/*      */   }
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/*  106 */     var8 = EntityList.func_75616_a(par1, par0World);
/*      */     
/*  108 */     if (var8 != null) {
/*      */ 
/*      */       
...
/*      */ 
/*      */       
/*  114 */       par0World.func_72838_d(var8);
/*      */       
/*  116 */       ((EntityLiving)var8).func_70642_aH();
/*      */     } 
/*      */     
/*  119 */     return var8;
/*      */   }
...
/*  130 */     int lvl = EnchantmentHelper.func_77506_a(Enchantment.field_77346_s.field_77352_x, stack);
/*  131 */     if (lvl <= 0) {
/*  132 */       stack.func_77966_a(Enchantment.field_77346_s, 2);
/*      */     }
/*      */   }
/*      */   
...
/*  145 */     Block var1 = world.func_147439_a(x, y, z);
/*      */     
/*  147 */     if (var1 == Blocks.field_150329_H)
/*  148 */       return Boolean.valueOf(true); 
/*  149 */     if (var1 == Blocks.field_150434_aF)
/*  150 */       return Boolean.valueOf(true); 
/*  151 */     if (var1 == Blocks.field_150328_O)
/*  152 */       return Boolean.valueOf(true); 
/*  153 */     if (var1 == Blocks.field_150327_N)
/*  154 */       return Boolean.valueOf(true); 
/*  155 */     if (var1 == Blocks.field_150362_t)
/*  156 */       return Boolean.valueOf(true); 
/*  157 */     if (var1 == Blocks.field_150433_aE)
...
/*      */     }
/*  164 */     if (world.func_147437_c(x, y, z) == true) {
...
/*  177 */     if (world.func_147437_c(x, y, z) == true)
/*  178 */       return Boolean.valueOf(true); 
/*  179 */     Block var1 = world.func_147439_a(x, y, z);
/*  180 */     if (var1 == Blocks.field_150348_b)
/*  181 */       return Boolean.valueOf(false); 
/*  182 */     if (var1 == Blocks.field_150357_h) {
...
/*  193 */     if (world.func_147439_a(par2, par3, par4) != Blocks.field_150350_a) {
/*      */       return;
/*      */     }
/*      */     
/*  197 */     FastSetBlock(world, par2, par3, par4, Blocks.field_150395_bd, par5, 2, chunk);
/*  198 */     while (par6 > 0) {
/*      */       
/*  200 */       par3--;
/*  201 */       if (world.func_147439_a(par2, par3, par4) != Blocks.field_150350_a) {
/*      */         return;
/*      */       }
/*      */       
/*  205 */       FastSetBlock(world, par2, par3, par4, Blocks.field_150395_bd, par5, 2, chunk);
/*  206 */       par6--;
/*      */     } 
/*      */   }
/*      */ 
...
/*      */               
/*  262 */               if (!bad_critters && world.func_147437_c(realx, y + 1, realz))
/*      */               {
/*  264 */                 FastSetBlock(world, realx, y + 1, realz, (Block)Blocks.field_150486_ae, 0, 2, chunk);
/*  265 */                 TileEntityChest chest = (TileEntityChest)world.func_147438_o(realx, y + 1, realz);
/*  266 */                 if (chest != null)
/*      */                 {
/*      */                   
/*  269 */                   WeightedRandomChestContent.func_76293_a(this.rand, this.chestContentsList, (IInventory)chest, 1 + this.rand.nextInt(8));
/*      */                 }
/*      */               }
/*      */             
...
/*      */ 
/*      */               
/*  276 */               if (!bad_critters && world.func_147437_c(realx, y + 1, realz) && world.func_147437_c(realx, y + 2, realz) && world.func_147437_c(realx, y + 3, realz)) {
/*      */ 
/*      */                 
/*  279 */                 Entity ent = null;
...
/*  331 */                       local_leaf_type = Blocks.field_150451_bX;
/*      */                     } else {
...
/*      */                     {
/*  559 */                       if (!bad_critters && world.func_147437_c(x, current_y + 1, z)) {
/*      */                         
/*  561 */                         FastSetBlock(world, x, current_y + 1, z, (Block)Blocks.field_150486_ae, 0, 2, chunk);
/*  562 */                         TileEntityChest chest = (TileEntityChest)world.func_147438_o(x, current_y + 1, z);
/*  563 */                         if (chest != null)
/*      */                         {
/*      */                           
/*  566 */                           WeightedRandomChestContent.func_76293_a(this.rand, this.chestContentsList, (IInventory)chest, t_radius - this_width + this.rand.nextInt(10));
/*      */                         }
/*      */                       } 
/*      */                     }
/*      */                   }
...
/*  649 */       FastSetBlock(world, x, current_y, z, Blocks.field_150475_bE, 0, 2, chunk);
/*  650 */       FastSetBlock(world, x, current_y + 1, z, Blocks.field_150475_bE, 0, 2, chunk);
/*      */       
/*  652 */       if (stepID == Blocks.field_150484_ah) {
/*      */         
/*  654 */         Entity var8 = null;
/*      */ 
/*      */         
/*  657 */         var8 = EntityList.func_75620_a("The King", world);
/*      */         
/*  659 */         if (var8 != null) {
/*      */ 
/*      */           
/*  662 */           var8.func_70012_b(x, (current_y + 4), z, world.field_73012_v.nextFloat() * 360.0F, 0.0F);
/*      */ 
/*      */           
/*  665 */           world.func_72838_d(var8);
/*      */           
/*  667 */           ((EntityLiving)var8).func_70642_aH();
...
/*      */ 
/*      */         
/*  676 */         var8 = EntityList.func_75620_a("The Queen", world);
/*      */         
/*  678 */         if (var8 != null) {
/*      */ 
/*      */           
/*  681 */           var8.func_70012_b(x, (current_y + 4), z, world.field_73012_v.nextFloat() * 360.0F, 0.0F);
/*      */ 
/*      */           
/*  684 */           world.func_72838_d(var8);
/*      */           
/*  686 */           ((EntityLiving)var8).func_70642_aH();
...
/*      */         {
/*  895 */           if (!bad_critters && world.func_147437_c(x, y + cury + 1, z)) {
/*      */             
/*  897 */             FastSetBlock(world, x, y + cury + 1, z, (Block)Blocks.field_150486_ae, 0, 2, chunk);
/*  898 */             TileEntityChest chest = (TileEntityChest)world.func_147438_o(x, y + cury + 1, z);
/*  899 */             if (chest != null)
/*      */             {
/*      */               
/*  902 */               WeightedRandomChestContent.func_76293_a(this.rand, this.chestContentsList, (IInventory)chest, t_radius - (int)rad + this.rand.nextInt(10));
/*      */             }
/*      */           } 
/*      */         }
/*      */       } 
...
/*  917 */           FastSetBlock(world, x, y + cury, z, Blocks.field_150484_ah, 0, 2, chunk);
/*      */         }
/*      */       }
/*      */     } 
/*      */   }
...
/*  987 */       if (cury > (int)rad) {
/*      */         
/*  989 */         ibranch += 80 + world.field_73012_v.nextInt(80);
/*  990 */         if (ibranch > 360) ibranch -= 360; 
/*  991 */         int ibranchlen = (int)(rad * 5.0D) + world.field_73012_v.nextInt((int)rad + 2);
...
/*      */       
/* 1024 */       cury++;
/* 1025 */       rad -= 0.01D * world.field_73012_v.nextInt(15);
/* 1026 */       if (rad <= 0.0D)
/*      */       {
/*      */ 
/*      */         
/* 1030 */         if (isBoringBaseBlock(world, (int)fx, y + cury, (int)fz).booleanValue()) {
/* 1031 */           FastSetBlock(world, (int)fx, y + cury, (int)fz, Blocks.field_150484_ah, 0, 2, chunk);
/*      */         }
/*      */       }
/*      */     } 
/*      */   }
...
/* 1095 */     Block var1 = world.func_147439_a(clickedX, clickedY, clickedZ);
/* 1096 */     if (var1 != Blocks.field_150349_c && var1 != Blocks.field_150458_ak && var1 != Blocks.field_150346_d) {
/* 1097 */       return false;
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/* 1103 */     BlockLeaves blockLeaves = Blocks.field_150362_t;
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/* 1111 */     if (!world.field_72995_K) {
/* 1112 */       world.func_147465_d(clickedX, clickedY, clickedZ, Blocks.field_150340_R, 0, 2);
/*      */     }
/* 1114 */     for (int var3 = 0; var3 < 6; var3++) {
/*      */       
/* 1116 */       par2EntityPlayer.field_70170_p.func_72869_a("largesmoke", (clickedX + 0.5F), ((clickedY + 1) + 0.25F), (clickedZ + 0.5F), 0.0D, 0.0D, 0.0D);
/* 1117 */       par2EntityPlayer.field_70170_p.func_72869_a("largeexplode", (clickedX + 0.5F), ((clickedY + 1) + 0.25F), (clickedZ + 0.5F), 0.0D, 0.0D, 0.0D);
/* 1118 */       par2EntityPlayer.field_70170_p.func_72869_a("reddust", (clickedX + 0.5F), ((clickedY + 1) + 0.25F), (clickedZ + 0.5F), 0.0D, 0.0D, 0.0D);
/*      */     } 
/*      */     
/* 1121 */     par2EntityPlayer.field_70170_p.func_72956_a((Entity)par2EntityPlayer, "random.explode", 2.8F, 1.5F);
/*      */     
/* 1123 */     if (!world.field_72995_K) {
/*      */       Block block;
...
/* 1130 */           MakeBigSquareTree(world, clickedX, clickedY, clickedZ, Blocks.field_150364_r, block, Blocks.field_150341_Y, tree_type, this.tree_radius, this.no_critters, (Chunk)null);
/*      */         } else {
/* 1132 */           MakeBigRoundTree(world, clickedX, clickedY, clickedZ, Blocks.field_150364_r, block, Blocks.field_150341_Y, tree_type, this.tree_radius, (Chunk)null);
/*      */         } 
/* 1134 */       } else if (rand_treetype == 1) {
/* 1135 */         if (OreSpawnMain.GinormousEmeraldTreeEnable != 0) {
/* 1136 */           if (this.rand.nextInt(2) == 0) {
/* 1137 */             MakeBigSquareTree(world, clickedX, clickedY, clickedZ, Blocks.field_150340_R, Blocks.field_150475_bE, Blocks.field_150484_ah, -1, this.tree_radius, true, (Chunk)null);
/*      */           } else {
/* 1139 */             MakeBigSquareTree(world, clickedX, clickedY, clickedZ, Blocks.field_150343_Z, OreSpawnMain.MyBlockRubyBlock, OreSpawnMain.MyBlockAmethystBlock, -1, this.tree_radius, true, (Chunk)null);
/*      */           } 
/*      */         } else {
/* 1142 */           MakeBigSquareTree(world, clickedX, clickedY, clickedZ, Blocks.field_150364_r, block, Blocks.field_150366_p, tree_type, this.tree_radius, this.no_critters, (Chunk)null);
/*      */         } 
/*      */       } else {
/* 1145 */         MakeBigCircularTree(world, clickedX, clickedY, clickedZ, Blocks.field_150364_r, block, Blocks.field_150341_Y, tree_type, this.tree_radius, this.no_critters, (Chunk)null);
/*      */       } 
/*      */     } 
/*      */     
/* 1149 */     if (!par2EntityPlayer.field_71075_bZ.field_75098_d)
/*      */     {
/* 1151 */       par1ItemStack.field_77994_a--;
/*      */     }
/*      */     
/* 1154 */     return true;
/*      */   }
...
/* 1159 */     this.field_77791_bV = iconRegister.func_94245_a("OreSpawn:" + func_77658_a().substring(5));
/*      */   }
/*      */ }


/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ItemMagicApple.class
