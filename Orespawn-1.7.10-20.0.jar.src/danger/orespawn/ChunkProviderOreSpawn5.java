...
/*   98 */     this.field_147435_p = par1World.func_72912_H().func_76067_t();
...
/*      */         
/*  114 */         float f = 10.0F / MathHelper.func_76129_c((j * j + k * k) + 0.2F);
...
/*  132 */     byte b0 = 63;
/*  133 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76937_a(this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
...
/*      */                   
/*  185 */                   p_147424_3_[j3 += short1] = Blocks.field_150355_j;
/*      */                 }
/*      */                 else {
/*      */                   
...
/*  214 */     this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (p_147422_1_ * 16), (p_147422_2_ * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
/*      */     
...
/*      */         
/*  248 */         p_150560_3_[i2] = Blocks.field_150357_h;
/*      */       }
/*      */       else {
/*      */         
/*  252 */         Block block2 = p_150560_3_[i2];
/*      */         
/*  254 */         if (block2 != null && block2.func_149688_o() != Material.field_151579_a) {
/*      */           
...
/*      */               } 
/*      */               
/*  273 */               if (l1 < 63 && (block == null || block.func_149688_o() == Material.field_151579_a)) {
/*      */ 
/*      */                 
/*  276 */                 block = Blocks.field_150355_j;
/*  277 */                 b0 = 0;
/*      */               } 
/*      */ 
/*      */               
...
/*  315 */     return func_73154_d(par1, par2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  328 */     this.biomesForGeneration = this.worldObj.func_72959_q().func_76933_b(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
...
/*  352 */     this.field_147426_g = this.noiseGen6.func_76305_a(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
/*  353 */     this.field_147427_d = this.field_147429_l.func_76304_a(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
/*  354 */     this.field_147428_e = this.field_147431_j.func_76304_a(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
/*  355 */     this.field_147425_f = this.field_147432_k.func_76304_a(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
...
/*  377 */             float f3 = biomegenbase1.field_76748_D;
/*  378 */             float f4 = biomegenbase1.field_76749_E;
/*      */             
/*  380 */             if (this.field_147435_p == WorldType.field_151360_e && f3 > 0.0F) {
/*      */               
/*  382 */               f3 = 1.0F + f3 * 2.0F;
/*  383 */               f4 = 1.0F + f4 * 4.0F;
/*      */             } 
...
/*      */             
/*  388 */             if (biomegenbase1.field_76748_D > biomegenbase.field_76748_D)
/*      */             {
/*  390 */               f5 /= 2.0F;
/*      */             }
/*      */             
...
/*  481 */     BlockFalling.field_149832_M = true;
/*  482 */     int k = par2 * 16;
/*  483 */     int l = par3 * 16;
/*  484 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(k + 16, l + 16);
/*  485 */     this.rand.setSeed(this.worldObj.func_72905_C());
/*  486 */     long i1 = this.rand.nextLong() / 2L * 2L + 1L;
/*  487 */     long j1 = this.rand.nextLong() / 2L * 2L + 1L;
/*  488 */     this.rand.setSeed(par2 * i1 + par3 * j1 ^ this.worldObj.func_72905_C());
/*  489 */     boolean flag = false;
/*      */ 
/*      */ 
/*      */     
/*  493 */     biomegenbase.func_76728_a(this.worldObj, this.rand, k, l);
/*  494 */     SpawnerAnimals.func_77191_a(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
/*      */ 
/*      */ 
/*      */     
/*  498 */     BlockFalling.field_149832_M = false;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  545 */     BiomeGenBase biomegenbase = this.worldObj.func_72807_a(par2, par4);
/*  546 */     return biomegenbase.func_76747_a(par1EnumCreatureType);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/*  665 */         if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.field_150350_a && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
/*      */           
/*  667 */           if (what == 0) {
...
/*  686 */       int ix = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2) + biasx;
/*  687 */       int iz = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2) + biasz;
/*  688 */       if (ix > 1) ix = 1; 
/*  689 */       if (ix < -1) ix = -1; 
/*  690 */       if (iz > 1) iz = 1; 
/*  691 */       if (iz < -1) iz = -1; 
/*  692 */       int iy = (world.field_73012_v.nextInt(3) > 0) ? 1 : 0;
/*  693 */       x += ix;
/*  694 */       z += iz;
/*  695 */       y += iy;
/*  696 */       Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y, z);
/*  697 */       if (bid != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves2) {
/*      */         return;
/*      */       }
...
/*  731 */     int i = 1 + world.field_73012_v.nextInt(2);
/*  732 */     int j = i + world.field_73012_v.nextInt(8);
/*      */     int k;
/*  734 */     for (k = 0; k < i; k++) {
/*  735 */       Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y + k, z);
/*  736 */       if (k >= 1 && bid != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves2) {
/*      */         return;
/*      */       }
...
/*      */     
/*  743 */     for (k = i; k < j; k++) {
/*  744 */       int ix = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2);
/*  745 */       int iz = world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2);
/*  746 */       int iy = (world.field_73012_v.nextInt(4) > 0) ? 1 : 0;
/*  747 */       x += ix;
/*  748 */       z += iz;
/*  749 */       y += iy;
/*  750 */       Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y, z);
/*  751 */       if (bid != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves2) {
/*      */         break;
/*      */       }
/*  754 */       OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x, y, z, OreSpawnMain.MyCrystalTreeLog, 0);
/*  755 */       if (world.field_73012_v.nextInt(4) == 1) {
/*  756 */         makeScragglyCrystalBranch(world, x, y, z, world.field_73012_v.nextInt(1 + j - k), world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2), world.field_73012_v.nextInt(2) - world.field_73012_v.nextInt(2), chunk);
/*      */       }
/*      */       
/*  759 */       for (int m = -1; m < 2; m++) {
/*  760 */         for (int n = -1; n < 2; n++) {
/*  761 */           if (world.field_73012_v.nextInt(2) == 1) {
/*  762 */             bid = OreSpawnMain.getBlockIDInChunk(chunk, x + m, y, z + n);
/*  763 */             if (bid == Blocks.field_150350_a) {
/*  764 */               OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x + m, y, z + n, OreSpawnMain.MyCrystalLeaves2, 0);
/*      */             }
/*      */           } 
/*      */         } 
/*      */       } 
/*  769 */       if (world.field_73012_v.nextInt(2) == 1) {
/*  770 */         bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y + 1, z);
/*  771 */         if (bid == Blocks.field_150350_a) {
...
/*  788 */     int i = 10 + world.field_73012_v.nextInt(12);
...
/*  793 */       i -= 4;
/*      */     }
/*  795 */     int j = i + world.field_73012_v.nextInt(18 - OreSpawnMain.LessLag * 2);
/*      */     int k;
/*  797 */     for (k = 0; k < i; k++) {
/*  798 */       Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x, y + k, z);
/*  799 */       if (k >= 1 && bid != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves) {
/*      */         return;
/*      */       }
...
/*  809 */       if (bid != Blocks.field_150350_a && bid != OreSpawnMain.MyCrystalTreeLog && bid != OreSpawnMain.MyCrystalLeaves) {
/*      */         break;
/*      */       }
...
/*  817 */             if (world.field_73012_v.nextInt(2) == 1) {
/*  818 */               bid = OreSpawnMain.getBlockIDInChunk(chunk, x + n, y, z + i1);
/*  819 */               if (bid == Blocks.field_150350_a) {
...
/*  831 */         if (world.field_73012_v.nextInt(2) == 1) {
/*  832 */           Block bid = OreSpawnMain.getBlockIDInChunk(chunk, x + m, y, z + n);
/*  833 */           if (bid == Blocks.field_150350_a) {
...
/*  842 */         if (bid == Blocks.field_150350_a) {
...
/*  851 */         if (bid == Blocks.field_150350_a) {
...
/*  877 */         Block b = Blocks.field_150350_a;
/*  878 */         switch (j) { case 0:
...
/*  937 */     double d0 = ((par3 + 8) + MathHelper.func_76126_a(f) * numberOfBlocks / 8.0F);
/*  938 */     double d1 = ((par3 + 8) - MathHelper.func_76126_a(f) * numberOfBlocks / 8.0F);
/*  939 */     double d2 = ((par5 + 8) + MathHelper.func_76134_b(f) * numberOfBlocks / 8.0F);
/*  940 */     double d3 = ((par5 + 8) - MathHelper.func_76134_b(f) * numberOfBlocks / 8.0F);
...
/*  950 */       double d10 = (MathHelper.func_76126_a(l * 3.1415927F / numberOfBlocks) + 1.0F) * d9 + 1.0D;
/*  951 */       double d11 = (MathHelper.func_76126_a(l * 3.1415927F / numberOfBlocks) + 1.0F) * d9 + 1.0D;
/*  952 */       int i1 = MathHelper.func_76128_c(d6 - d10 / 2.0D);
/*  953 */       int j1 = MathHelper.func_76128_c(d7 - d11 / 2.0D);
/*  954 */       int k1 = MathHelper.func_76128_c(d8 - d10 / 2.0D);
/*  955 */       int l1 = MathHelper.func_76128_c(d6 + d10 / 2.0D);
/*  956 */       int i2 = MathHelper.func_76128_c(d7 + d11 / 2.0D);
/*  957 */       int j2 = MathHelper.func_76128_c(d8 + d10 / 2.0D);
/*      */       
...
/*      */ 
/*      */         
/* 1002 */         if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.field_150350_a && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
/*      */           
...
/*      */ 
/*      */         
/* 1021 */         if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.field_150350_a && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
/*      */           
...
/*      */ 
/*      */         
/* 1047 */         if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.field_150350_a && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
/*      */           
/* 1049 */           if (what == 0) {
...
/* Location:              F:\CODEX\P10\Orespawn-1.7.10-20.0.jar!\danger\orespawn\ChunkProviderOreSpawn5.class
