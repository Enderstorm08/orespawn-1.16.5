...
public class ExactAttributeShovelItem extends ShovelItem {
    private final Multimap<Attribute, AttributeModifier> mainHandModifiers;

    public ExactAttributeShovelItem(IItemTier tier, float attackDamage, float attackSpeed, Properties properties) {
