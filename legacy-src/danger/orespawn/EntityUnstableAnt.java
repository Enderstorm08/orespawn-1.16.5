...
extends EntityAnt {
    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (par1EntityPlayer.field_71093_bK != OreSpawnMain.DimensionID4) {
            MinecraftServer.func_71276_C().func_71203_ab().transferPlayerToDimension((EntityPlayerMP)par1EntityPlayer, OreSpawnMain.DimensionID4, (Teleporter)new OreSpawnTeleporter(MinecraftServer.func_71276_C().func_71218_a(OreSpawnMain.DimensionID4), OreSpawnMain.DimensionID4, this.field_70170_p));
        } else {
