...
extends ModelBase {
    ...
    public ModelVelocityRaptor(float f1) {
        ...
        this.hf3.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.hf4.func_78789_a(0.0f, -0.2f, 0.0f, 0, 1, 3);
        ...
        this.hf2.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.hf1.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 2);
        ...
        this.lff2.func_78789_a(0.5f, 2.5f, 3.0f, 0, 1, 3);
        ...
        this.lff1.func_78789_a(0.5f, 2.0f, 2.0f, 0, 1, 3);
        ...
        this.lff3.func_78789_a(0.5f, 1.0f, 4.0f, 0, 1, 3);
        ...
        this.rff2.func_78789_a(-0.5f, 2.5f, 3.0f, 0, 1, 3);
        ...
        this.rff3.func_78789_a(-0.5f, 1.0f, 4.0f, 0, 1, 3);
        ...
        this.rff1.func_78789_a(-0.5f, 2.0f, 2.0f, 0, 1, 3);
        ...
        this.tf4.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.tf1.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.Shape1.func_78789_a(-2.0f, 0.0f, 0.0f, 4, 7, 11);
        ...
        this.neck.func_78789_a(-1.0f, -7.0f, -2.0f, 2, 8, 3);
        ...
        this.head1.func_78789_a(-2.0f, 0.0f, -7.0f, 3, 4, 7);
        ...
        this.lf1.func_78789_a(0.0f, 0.0f, 0.0f, 1, 3, 2);
        ...
        this.lf2.func_78789_a(0.0f, 1.0f, 2.0f, 1, 4, 1);
        ...
        this.head2.func_78789_a(-1.0f, 0.0f, -10.0f, 2, 4, 4);
        ...
        this.tail1.func_78789_a(-1.0f, 0.0f, 0.0f, 2, 5, 4);
        ...
        this.tail2.func_78789_a(0.0f, 0.0f, 0.0f, 1, 2, 10);
        ...
        this.bl1.func_78789_a(-1.0f, 0.0f, 0.0f, 2, 6, 4);
        ...
        this.br1.func_78789_a(-1.0f, 0.0f, 0.0f, 2, 6, 4);
        ...
        this.bl2.func_78789_a(-1.0f, 5.0f, -3.0f, 2, 5, 2);
        ...
        this.br2.func_78789_a(-1.0f, 5.0f, -3.0f, 2, 5, 2);
        ...
        this.bl3.func_78789_a(-1.0f, 9.0f, -1.0f, 2, 2, 4);
        ...
        this.br3.func_78789_a(-1.0f, 9.0f, -1.0f, 2, 2, 4);
        ...
        this.rf1.func_78789_a(-1.0f, 0.0f, 0.0f, 1, 3, 2);
        ...
        this.rf2.func_78789_a(-1.0f, 1.0f, 2.0f, 1, 4, 1);
        ...
        this.tf2.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.tf3.func_78789_a(0.0f, 0.0f, 0.0f, 0, 1, 3);
        ...
        this.bl4.func_78789_a(-1.0f, 6.0f, -5.0f, 1, 3, 1);
        ...
        this.br4.func_78789_a(0.0f, 6.0f, -5.0f, 1, 3, 1);
        ...
        this.Hat1.func_78789_a(0.0f, 0.0f, 0.0f, 4, 1, 5);
        ...
        this.Hat2.func_78789_a(0.0f, 0.0f, 0.0f, 3, 2, 3);
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        hf = (float)c.getVHealth() / c.func_110138_aP();
        this.hf1.field_78796_g = newangle = MathHelper.func_76134_b((float)(f2 * 1.25f * this.wingspeed * hf)) * (float)Math.PI * 0.1f * hf;
        this.hf2.field_78796_g = -newangle;
        this.hf3.field_78796_g = newangle;
        this.hf4.field_78796_g = -newangle;
        newangle = MathHelper.func_76134_b((float)(f2 * 0.3f)) * (float)Math.PI * 0.05f;
        ...
        this.lff1.field_78796_g = newangle = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        newangle = c.func_70906_o() ? 0.0f : MathHelper.func_76134_b((float)(f2 * 1.4f * this.wingspeed * hf)) * (float)Math.PI * 0.25f * hf;
