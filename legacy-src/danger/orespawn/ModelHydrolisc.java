...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        hf = (float)c.getHydroHealth() / c.func_110138_aP();
        this.feather2.field_78796_g = newangle = MathHelper.func_76134_b((float)(f2 * 1.25f * this.wingspeed * hf)) * (float)Math.PI * 0.2f * hf;
        newangle = MathHelper.func_76134_b((float)(f2 * 0.75f * this.wingspeed * hf)) * (float)Math.PI * 0.2f * hf;
