...
extends EntityTameable {
    ...
    public ThePrinceAdult(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityLiving.class, 20.0f));
    ...
    public void func_70619_bc() {
        ...
        if (this.getActivity() == 0 && this.field_70153_n == null && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.func_70909_n() && OreSpawnMain.FullPowerKingEnable != 0) {
            ...
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature(this.field_70170_p, "The King", this.field_70165_t, this.field_70163_u, this.field_70161_v);
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.func_70106_y();
    ...
    public void fly_with_rider() {
        ...
        if (this.field_70170_p.field_73012_v.nextInt(5) == 1 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                this.setAttacking(1);
                if (this.func_70068_e((Entity)e) < (double)((10.0f + e.field_70130_N / 2.0f) * (10.0f + e.field_70130_N / 2.0f))) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(32.0, 20.0, 32.0));
    ...
    public void func_70071_h_() {
        ...
        if (this.getActivity() == 0 && this.func_70909_n() && this.func_70902_q() != null && !this.func_70906_o() && this.func_70068_e((Entity)(e = this.func_70902_q())) > 900.0) {
            this.setActivity(1);
        }
    }
    ...
    private void fly_without_rider() {
        ...
        if (!toofar && this.flyaway == 0 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                if (this.field_70153_n != null) {
                    ...
                    if (this.fireballticker == 0 && (pp.field_70702_br < -0.001f || pp.field_70702_br > 0.001f)) {
                        ...
                        if (this.which_attack == 1) {
                            cx = this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z + 10.0f));
                            cz = this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z + 10.0f));
                            IceBall var2 = new IceBall(this.field_70170_p, cx, this.field_70163_u + (yoff -= (double)((float)this.getHead3Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 2) {
                            ...
                            lb.func_70012_b(cx, this.field_70163_u + (yoff -= (double)((float)this.getHead2Ext() * 0.08f)), cz, pp.field_70177_z + 90.0f, pp.field_70125_A);
                    ...
                    if (!this.field_70170_p.field_72995_K && (list = this.field_70170_p.func_72839_b((Entity)this, this.field_70121_D.func_72314_b(6.25, 10.0, 6.25))) != null && !list.isEmpty()) {
    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.func_77973_b() == Item.func_150898_a((Block)Blocks.field_150484_ah) && par1EntityPlayer.func_70068_e((Entity)this) < 36.0) {
            if (!this.field_70170_p.field_72995_K) {
        ...
        if (this.func_70909_n()) {
            ...
            if (var2 != null && var2.func_77973_b() == Item.func_150898_a((Block)Blocks.field_150432_aD) && par1EntityPlayer.func_70068_e((Entity)this) < 36.0) {
                if (!this.field_70170_p.field_72995_K) {
                    this.func_70908_e(true);
            ...
            if (var2 != null && var2.func_77973_b() == Items.field_151045_i && par1EntityPlayer.func_70068_e((Entity)this) < 36.0 && !this.field_70170_p.field_72995_K) {
                ...
                ent = ThePrinceAdult.spawnCreature(this.field_70170_p, "The Young Prince", this.field_70165_t, this.field_70163_u, this.field_70161_v);
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.func_70909_n()) {
                        d.func_70903_f(true);
