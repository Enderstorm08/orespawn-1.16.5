...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 4.0f * this.wingspeed)) * (float)Math.PI * 0.5f * f1;
        ...
        if (e.getAttacking() == 0) {
            ...
            float fanamp = 0.1f;
            this.fan.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed)) * (float)Math.PI * fanamp;
            this.fanl1.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 1.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl2.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 2.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl3.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 3.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl4.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 4.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl5.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 5.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl6.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 6.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl7.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 7.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr1.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 1.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr2.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 2.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr3.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 3.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr4.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 4.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr5.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 5.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr6.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 6.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr7.field_78795_f = MathHelper.func_76134_b((float)(f2 * fanspeed * this.wingspeed - 7.0f * pi6)) * (float)Math.PI * fanamp;
            this.fan.field_78808_h = 0.0f;
        ...
        r = e.getRenderInfo();
        newangle = MathHelper.func_76134_b((float)(f2 * 3.5f * this.wingspeed)) * (float)Math.PI * 0.5f;
        nextangle = MathHelper.func_76134_b((float)((f2 + 0.2f) * 3.5f * this.wingspeed)) * (float)Math.PI * 0.5f;
        ...
        if (r.ri2 == 1) {
            ...
            newangle = MathHelper.func_76134_b((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.05f;
            this.doTail(newangle);
        }
        if (r.ri3 == 1) {
            newangle = MathHelper.func_76134_b((float)(f2 * 3.5f * this.wingspeed)) * (float)Math.PI * 0.35f;
            this.doJaw(newangle);
        } else {
            newangle = MathHelper.func_76134_b((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.02f;
            this.doJaw(newangle);
        }
        newangle = MathHelper.func_76134_b((float)(f2 * this.wingspeed * 3.5f)) * (float)Math.PI * 0.2f;
        if (r.ri1 == 1 || r.ri1 == 3) {
            this.doLeftClaw(newangle);
        } else {
            newangle = MathHelper.func_76134_b((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.03f;
            this.doLeftClaw(newangle);
        }
        if (r.ri1 == 2 || r.ri1 == 3) {
    ...
    private void doJaw(float angle) {
        this.jaw2.field_78795_f = this.jaw1.field_78795_f = Math.abs(angle);
    }

    private void doTail(float angle) {
        this.spike1.field_78796_g = this.tail1.field_78796_g = angle * 0.25f;
