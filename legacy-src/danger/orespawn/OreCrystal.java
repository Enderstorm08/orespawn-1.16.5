...
extends Block {
    ...
    private void sparkle(World par1World, int par2, int par3, int par4) {
        ...
        for (int j1 = 0; j1 < 5; ++j1) {
            ...
            if (which == 1) {
                par1World.func_72869_a("smoke", (double)((float)par2 + dx), (double)par3 + (double)dy, (double)((float)par4 + dz), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f));
            }
            if (which != 2) continue;
            par1World.func_72869_a("reddust", (double)((float)par2 + dx), (double)par3 + (double)dy, (double)((float)par4 + dz), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f), (double)((par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0f));
        }
    }
    ...
    public void func_149664_b(World par1World, int par2, int par3, int par4, int par5) {
        if (!par1World.field_72995_K && par1World.field_73012_v.nextInt(3) == 1) {
            par1World.func_72885_a((Entity)null, (double)((float)par2 + 0.5f), (double)((float)par3 + 0.5f), (double)((float)par4 + 0.5f), 1.5f, true, par1World.func_82736_K().func_82766_b("mobGriefing"));
        }
