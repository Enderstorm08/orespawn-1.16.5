...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.nose.field_78795_f = this.head.field_78795_f = (float)Math.toRadians(f4) * 0.45f;
        ...
        this.bump1.field_78795_f = this.guard.field_78795_f = this.head.field_78795_f - 0.262f;
        ...
        newangle = e.getAttacking() != 0 ? MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f : MathHelper.func_76134_b((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.05f;
        this.tail.field_78796_g = newangle;
        newangle = MathHelper.func_76134_b((float)(f2 * 0.02f * this.wingspeed)) * (float)Math.PI * 0.15f;
