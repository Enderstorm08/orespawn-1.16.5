...
extends WorldProvider {
    private BiomeGenUtopianPlains MyPlains = (BiomeGenUtopianPlains)new BiomeGenUtopianPlains(OreSpawnMain.BiomeIslandsID).func_76739_b(353825).func_76735_a("Islands").func_76732_a(0.7f, 0.5f);
    ...
    public IChunkProvider func_76555_c() {
        return new ChunkProviderOreSpawn4(this.field_76579_a, this.field_76579_a.func_72905_C(), true);
    }
}
