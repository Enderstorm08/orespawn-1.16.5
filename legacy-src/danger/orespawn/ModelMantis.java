...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.lfwing.field_78808_h = -0.698f - newangle;
        this.rfwing.field_78808_h = 0.698f + newangle;
        newangle = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.lrwing.field_78808_h = -0.349f + newangle;
        this.rrwing.field_78808_h = 0.349f - newangle;
        if (b.getAttacking() == 0) {
            newangle = MathHelper.func_76134_b((float)(f2 * 0.051f * this.wingspeed)) * (float)Math.PI * 0.013f;
            a1 = -0.2f;
        } else {
            newangle = MathHelper.func_76134_b((float)(f2 * 0.51f * this.wingspeed)) * (float)Math.PI * 0.25f;
            a1 = -0.698f;
        }
        this.larm1.field_78795_f = a1 + newangle;
        this.larm2.field_78798_e = (float)((double)(this.larm1.field_78798_e + 1.0f) + Math.sin(this.larm1.field_78795_f) * 22.0);
        this.larm2.field_78797_d = (float)((double)this.larm1.field_78797_d + Math.cos(this.larm1.field_78795_f) * 22.0);
        this.larm2.field_78795_f = -a1 - newangle;
        this.larm3.field_78798_e = (float)((double)(this.larm2.field_78798_e + 1.0f) - Math.sin(this.larm2.field_78795_f) * 17.0);
        this.larm3.field_78797_d = (float)((double)this.larm2.field_78797_d - Math.cos(this.larm2.field_78795_f) * 17.0);
        this.larm3.field_78795_f = a1 + newangle;
        this.rarm1.field_78795_f = a1 - newangle;
        this.rarm2.field_78798_e = (float)((double)(this.rarm1.field_78798_e + 1.0f) + Math.sin(this.rarm1.field_78795_f) * 22.0);
        this.rarm2.field_78797_d = (float)((double)this.rarm1.field_78797_d + Math.cos(this.rarm1.field_78795_f) * 22.0);
        this.rarm2.field_78795_f = -a1 + newangle;
        this.rarm3.field_78798_e = (float)((double)(this.rarm2.field_78798_e + 1.0f) - Math.sin(this.rarm2.field_78795_f) * 17.0);
        this.rarm3.field_78797_d = (float)((double)this.rarm2.field_78797_d - Math.cos(this.rarm2.field_78795_f) * 17.0);
