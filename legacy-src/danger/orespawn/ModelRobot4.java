...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.15f * f1 : 0.0f;
        ...
        this.head.field_78796_g = (float)Math.toRadians((double)f3 / 1.5);
        float amp = 0.7853982f;
        if (e.getAttacking() != 0) {
            newangle = MathHelper.func_76134_b((float)((float)Math.toRadians(f2 % 360.0f) * this.wingspeed * 6.0f)) * amp;
        ...
        double newposy = (float)((double)this.leftsholder.field_78797_d + Math.cos(this.leftupperarm.field_78795_f) * 14.0);
        double newposz = (float)((double)this.leftsholder.field_78798_e + Math.sin(this.leftupperarm.field_78795_f) * 14.0);
