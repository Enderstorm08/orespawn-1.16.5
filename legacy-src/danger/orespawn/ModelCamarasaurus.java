...
extends ModelBase {
    ...
    public ModelCamarasaurus(float f1) {
        ...
        this.Body1.func_78789_a(-6.0f, 0.0f, 0.0f, 12, 12, 12);
        ...
        this.Body2.func_78789_a(-5.0f, 0.0f, 0.0f, 10, 10, 6);
        ...
        this.Body3.func_78789_a(-4.0f, 0.0f, 0.0f, 8, 8, 4);
        ...
        this.Body4.func_78789_a(-5.0f, 0.0f, 0.0f, 10, 10, 4);
        ...
        this.Tail0.func_78789_a(-3.0f, -2.0f, 0.0f, 6, 6, 6);
        ...
        this.Neck1.func_78789_a(-3.0f, 0.0f, 0.0f, 6, 6, 5);
        ...
        this.Neck2.func_78789_a(-2.0f, 0.0f, -6.0f, 4, 4, 7);
        ...
        this.Neck3.func_78789_a(-2.0f, -2.0f, -12.0f, 4, 4, 13);
        ...
        this.Head1.func_78789_a(-4.0f, -3.0f, -6.0f, 8, 6, 6);
        ...
        this.Head2.func_78789_a(-3.0f, -2.0f, -4.0f, 6, 4, 4);
        ...
        this.Tail1.func_78789_a(-2.0f, -3.0f, 0.0f, 4, 4, 9);
        ...
        this.Tail2.func_78789_a(-1.0f, -1.0f, 0.0f, 2, 2, 8);
        ...
        this.Tail3.func_78789_a(-0.5f, -0.5f, 0.0f, 1, 1, 7);
        ...
        this.BLegupleft.func_78789_a(0.0f, 0.0f, 0.0f, 6, 8, 6);
        ...
        this.FLegupleft.func_78789_a(0.0f, 0.0f, -6.0f, 6, 9, 6);
        ...
        this.BLegupright.func_78789_a(-6.0f, 0.0f, 0.0f, 6, 8, 6);
        ...
        this.FLegupright.func_78789_a(-6.0f, 0.0f, -6.0f, 6, 9, 6);
        ...
        this.BLegdownright.func_78789_a(-5.0f, 7.0f, -1.0f, 5, 8, 5);
        ...
        this.FLegdownleft.func_78789_a(0.0f, 8.0f, -6.0f, 5, 8, 5);
        ...
        this.FLegdownright.func_78789_a(-5.0f, 8.0f, -6.0f, 5, 8, 5);
        ...
        this.BLegdownleft.func_78789_a(0.0f, 7.0f, -1.0f, 5, 8, 5);
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        hf = (float)c.getCamarasaurusHealth() / c.func_110138_aP();
        newangle = MathHelper.func_76134_b((float)(f2 * 1.5f * this.wingspeed * hf)) * (float)Math.PI * 0.25f * hf;
        if (c.func_70906_o()) {
            newangle = 0.0f;
        }
