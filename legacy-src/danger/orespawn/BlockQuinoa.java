...
extends BlockReed {
    ...
    public boolean func_149742_c(World par1World, int par2, int par3, int par4) {
        ...
        return bid == OreSpawnMain.MyQuinoaPlant1 || bid == OreSpawnMain.MyQuinoaPlant2 || bid == OreSpawnMain.MyQuinoaPlant3 || bid == OreSpawnMain.MyQuinoaPlant4 || bid == Blocks.field_150349_c || bid == Blocks.field_150346_d || bid == Blocks.field_150458_ak || bid == OreSpawnMain.CrystalGrass;
    }
    ...
    public void func_149674_a(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if ((bid = par1World.func_147439_a(par2, par3 + 1, par4)) == Blocks.field_150350_a) {
            for (int var6 = 1; var6 < 10 && ((bid = par1World.func_147439_a(par2, par3 - var6, par4)) == OreSpawnMain.MyQuinoaPlant1 || bid == OreSpawnMain.MyQuinoaPlant2 || bid == OreSpawnMain.MyQuinoaPlant3 || bid == OreSpawnMain.MyQuinoaPlant4); ++var6) {
                ++Height;
