...
extends Item {
    ...
    public ItemStack func_77659_a(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (this.cage_id == cc.cage_id) {
            ...
            if (!par2World.field_72995_K) {
                par2World.func_72838_d((Entity)new EntityCage(par2World, par3EntityPlayer, this.cage_id));
            }
        }
    ...
    public boolean func_77648_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
        ...
        for (int var3 = 0; var3 < 6; ++var3) {
            par2EntityPlayer.field_70170_p.func_72869_a("smoke", (double)((float)par4 + 0.5f), (double)((float)par5 + 1.25f), (double)((float)par6 + 0.5f), 0.0, 0.0, 0.0);
            par2EntityPlayer.field_70170_p.func_72869_a("explode", (double)((float)par4 + 0.5f), (double)((float)par5 + 1.25f), (double)((float)par6 + 0.5f), 0.0, 0.0, 0.0);
            par2EntityPlayer.field_70170_p.func_72869_a("reddust", (double)((float)par4 + 0.5f), (double)((float)par5 + 1.25f), (double)((float)par6 + 0.5f), 0.0, 0.0, 0.0);
        }
        par2EntityPlayer.field_70170_p.func_72956_a((Entity)par2EntityPlayer, "random.explode", 1.0f, 1.5f);
        ...
        if (entityID != 0 || name != null) {
            ...
            if (ent != null) {
                ent.func_145779_a(OreSpawnMain.CageEmpty, 1);
                if (entityID == 51 && skelly_type != 0) {
                    EntitySkeleton sk = (EntitySkeleton)ent;
                    sk.func_82201_a(skelly_type);
                }
    ...
    public static Entity spawnCreature(World par0World, int par1, String name, double par2, double par4, double par6) {
        ...
        if (var8 != null) {
            ...
            if ((par1 == 100 || par1 == 120) && var8 instanceof EntityLiving) {
                ...
                sk.func_110161_a((IEntityLivingData)null);
            }
