        ...
        if (OreSpawnMain.LessOre == 0) {
            if (OreSpawnMain.Diamond_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.Diamond_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150482_ag, OreSpawnMain.Diamond_stats.clumpsize);
                }
            }
            if (OreSpawnMain.BlkDiamond_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.BlkDiamond_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150484_ah, OreSpawnMain.BlkDiamond_stats.clumpsize);
                }
            }
            if (OreSpawnMain.Emerald_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.Emerald_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150412_bA, OreSpawnMain.Emerald_stats.clumpsize);
                }
            }
            if (OreSpawnMain.BlkEmerald_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.BlkEmerald_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150475_bE, OreSpawnMain.BlkEmerald_stats.clumpsize);
                }
            }
            if (OreSpawnMain.Gold_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.Gold_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150352_o, OreSpawnMain.Gold_stats.clumpsize);
                }
            }
            if (OreSpawnMain.BlkGold_stats.rate > 0) {
                for (i = 0; i < OreSpawnMain.BlkGold_stats.rate; ++i) {
                    ...
                    this.generateBlockOre(world, random, randPosX, randPosY, randPosZ, chunk, Blocks.field_150340_R, OreSpawnMain.BlkGold_stats.clumpsize);
                }
            }
            ...
            for (int k2 = i1; k2 <= l1; ++k2) {
                ...
                for (int l2 = j1; l2 <= i2; ++l2) {
                    ...
                    for (int i3 = k1; i3 <= j2; ++i3) {
                        ...
                        if (!(d12 * d12 + d13 * d13 + d14 * d14 < 1.0) || bid != Blocks.field_150348_b) continue;
