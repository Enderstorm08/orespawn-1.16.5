...
extends Item {
    ...
    public boolean func_77648_a(ItemStack par1ItemStack, EntityPlayer Player, World world, int cposx, int cposy, int cposz, int par7, float par8, float par9, float par10) {
        ...
        for (int k = 1; k < length && (bid = world.func_147439_a(x + k * deltax, y - 1, z + k * deltaz)) == Blocks.field_150350_a; ++k) {
            world.func_147465_d(x + k * deltax, y - 1, z + k * deltaz, Blocks.field_150347_e, 0, 2);
            if ((k - 1) % 8 != 0 || (bid = world.func_147439_a(x + k * deltax, y, z + k * deltaz)) != Blocks.field_150350_a) continue;
