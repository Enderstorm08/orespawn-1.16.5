...
extends ModelBase {
    ...
    public ModelBasilisk(float f1) {
        ...
        this.body3.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.body2.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.body1.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.body4.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.body5.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.body6.func_78789_a(0.0f, 0.0f, 0.0f, 15, 15, 17);
        ...
        this.tail1.func_78789_a(0.0f, 0.0f, 0.0f, 13, 13, 15);
        ...
        this.tail2.func_78789_a(0.0f, 0.0f, 0.0f, 10, 10, 13);
        ...
        this.tail3.func_78789_a(0.0f, 0.0f, 0.0f, 8, 8, 13);
        ...
        this.tail4.func_78789_a(0.0f, 0.0f, 0.0f, 6, 6, 13);
        ...
        this.neck2.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.neck1.func_78789_a(0.0f, 0.0f, 0.0f, 16, 16, 16);
        ...
        this.head.func_78789_a(0.0f, 0.0f, 0.0f, 16, 18, 10);
        ...
        this.rog_1.func_78789_a(0.0f, 0.0f, 0.0f, 3, 3, 5);
        ...
        this.rog_2.func_78789_a(0.0f, 0.0f, 0.0f, 3, 3, 5);
        ...
        this.rog_3.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 4);
        ...
        this.rog_4.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 4);
        ...
        this.rog_5.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 4);
        ...
        this.rog_6.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 4);
        ...
        this.snout.func_78789_a(0.0f, 0.0f, 0.0f, 14, 16, 9);
        ...
        this.jaw.func_78789_a(0.0f, 0.0f, 0.0f, 14, 16, 3);
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f * f1 : 0.0f;
        float pi4 = 0.7853975f;
        this.body1.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body2.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body3.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body4.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body5.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body6.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail1.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail2.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail3.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail4.field_78796_g = MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 9.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        this.jaw.field_78795_f = e.getAttacking() != 0 ? -1.0f + MathHelper.func_76134_b((float)(f2 * 0.45f)) * (float)Math.PI * 0.18f : -1.1f;
