...
extends RenderLiving {
    protected ModelLurkingTerror model = (ModelLurkingTerror)this.field_77045_g;
    ...
    public void renderLurkingTerror(LurkingTerror par1EntityLurkingTerror, double par2, double par4, double par6, float par8, float par9) {
        super.func_76986_a((EntityLiving)par1EntityLurkingTerror, par2, par4, par6, par8, par9);
    }
