...
public class Trees {
    ...
    private void WindTreeBranch(World world, int x, int y, int z, int length, int dirx, int dirz) {
        for (int i = 1; i <= length; ++i) {
            ...
            if (Blocks.field_150350_a != world.func_147439_a(x + i * dirx - dirz, y, z + i * dirz - dirx)) continue;
            OreSpawnMain.setBlockFast(world, x + i * dirx - dirz, y, z + i * dirz - dirx, (Block)Blocks.field_150362_t, 0, 2);
        }
    ...
    public void WindTree(World world, int x, int y, int z, int dir) {
        ...
        if ((bid = world.func_147439_a(x, y, z)) != Blocks.field_150349_c && bid != Blocks.field_150346_d) {
            return;
        }
        int height = world.field_73012_v.nextInt(8) + 40;
        int width = world.field_73012_v.nextInt(4) + 8;
    ...
    public void SkyTree(World world, int x, int y, int z) {
        ...
        this.SkyTreeBranch(world, x, height, z, width, 0, -1);
        height -= 5;
        this.SkyTreeBranch(world, x, height -= world.field_73012_v.nextInt(4), z, width /= 3, 1, 0);
        this.SkyTreeBranch(world, x, height, z, width, -1, 0);
        this.SkyTreeBranch(world, x, height, z, width, 0, 1);
        this.SkyTreeBranch(world, x, height, z, width, 0, -1);
    }
    ...
    public void DuplicatorTree(World world, int x, int y, int z) {
        ...
        for (i = -1; i <= 1; ++i) {
            for (j = -1; j <= 1; ++j) {
                if (j == 0 && i == 0 || (bid = world.func_147439_a(x + i, realy + 3, z + j)) == OreSpawnMain.MyAppleLeaves) continue;
        ...
        for (int tries = 0; tries < 20 && (bidm == Blocks.field_150350_a || bidm == OreSpawnMain.MyDT); ++tries) {
            ...
            int meta = world.func_72805_g(x + i, realy + 1, z + j);
            if (bidm == Blocks.field_150350_a || bidm == OreSpawnMain.MyDT) continue;
            for (int k = 0; k < 20; ++k) {
                i = world.field_73012_v.nextInt(5) - 2;
                bid = world.func_147439_a(x + i, realy + 1, z + (j = world.field_73012_v.nextInt(5) - 2));
        ...
        for (int l1 = -3; l1 <= 3; ++l1) {
            for (int l2 = -3; l2 <= 3; ++l2) {
                for (int l3 = 0; l3 <= 2; ++l3) {
                    Block bid = world.func_147439_a(x + l1, y + l3, z + l2);
                    if (bid != Blocks.field_150350_a) continue;
    ...
    private void grow_small_branch(World world, int x, int y, int z, int xdir, int zdir, int xxdir, int zzdir) {
        ...
        int j = y;
        int k = z;
        int grow = 4 + world.field_73012_v.nextInt(2);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i, j, k);
            ++j;
            i2 = i += xdir;
            k2 = k += zdir;
        }
        grow = 4 + world.field_73012_v.nextInt(3);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i, j, k);
            i += xdir;
        ...
        grow = 4 + world.field_73012_v.nextInt(3);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i2, j, k2, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i2, j, k2);
            i2 += xxdir;
            k2 += zzdir;
        }
        j2 = --j;
        grow = 3 + world.field_73012_v.nextInt(3);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i, j, k);
            i += xdir;
    ...
    private void grow_branch(World world, int x, int y, int z, int xdir, int zdir, int xxdir, int zzdir) {
        ...
        int j = y;
        int k = z;
        int grow = 5 + world.field_73012_v.nextInt(4);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i, j, k);
            ++j;
        ...
        grow = 6 + world.field_73012_v.nextInt(5);
        for (n = 0; n < grow; ++n) {
            OreSpawnMain.setBlockFast(world, i, j, k, Blocks.field_150364_r, 0, 2);
            this.make_leaves(world, i, j, k);
            i += xdir;
    ...
    public void ExperienceTree(World world, int x, int y, int z) {
        ...
        int grow = 5 + world.field_73012_v.nextInt(6);
    ...
    public void SmallTree(World world, int x, int y, int z) {
        ...
        if ((bid = world.func_147439_a(x, realy + 4, z)) == Blocks.field_150350_a) {
            OreSpawnMain.setBlockFast(world, x, realy + 4, z, OreSpawnMain.MyAppleLeaves, 0, 2);
        }
        for (int i = -1; i <= 1; ++i) {
            for (int j = -1; j <= 1; ++j) {
    ...
    public void makeScragglyBranch(World world, int x, int y, int z, int len, int biasx, int biasz) {
        for (int k = 0; k < len; ++k) {
            ...
            if ((bid = world.func_147439_a(x += ix, y += (iy = world.field_73012_v.nextInt(3) > 0 ? 1 : 0), z += iz)) != Blocks.field_150350_a && bid != Blocks.field_150364_r && bid != OreSpawnMain.MyAppleLeaves) {
                return;
            }
    ...
    public void ScragglyTreeWithBranches(World world, int x, int y, int z) {
        Block bid;
        int k;
        int i = 1 + world.field_73012_v.nextInt(3);
        int j = i + world.field_73012_v.nextInt(12);
        for (k = 0; k < i; ++k) {
    ...
    public void FairyTree(World world, int x, int y, int z) {
        ...
        int grow = 5 + world.field_73012_v.nextInt(5);
        for (j = 6; j < 6 + grow; ++j) {
            for (i = 0; i < 2; ++i) {
                for (k = 0; k < 2; ++k) {
                    OreSpawnMain.setBlockFast(world, x + i, y + j, z + k, OreSpawnMain.MyCrystalTreeLog, 0, 2);
        ...
        TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(x - 1, y + 1, z);
        if (tileentitymobspawner != null) {
            tileentitymobspawner.func_145881_a().func_98272_a("Fairy");
        }
        world.func_147465_d(x + 2, y + 1, z, (Block)Blocks.field_150486_ae, 0, 2);
        TileEntityChest chest = (TileEntityChest)world.func_147438_o(x + 2, y + 1, z);
        if (chest != null) {
            WeightedRandomChestContent.func_76293_a((Random)world.field_73012_v, (WeightedRandomChestContent[])CrystalChestContentsList, (IInventory)chest, (int)(1 + world.field_73012_v.nextInt(5)));
        }
    }
    ...
    public void addSomething(World world, int x, int y, int z) {
        ...
        if (i == 1) {
            ...
            TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.func_147438_o(x, y + 1, z);
            if (tileentitymobspawner != null) {
                tileentitymobspawner.func_145881_a().func_98272_a("Fairy");
            }
        }
        if (i == 2) {
            ...
            TileEntityChest chest = (TileEntityChest)world.func_147438_o(x, y + 1, z);
            if (chest != null) {
                WeightedRandomChestContent.func_76293_a((Random)world.field_73012_v, (WeightedRandomChestContent[])CrystalChestContentsList, (IInventory)chest, (int)(1 + world.field_73012_v.nextInt(5)));
            }
        }
    ...
    public void FairyCastleTree(World world, int x, int y, int z) {
        ...
        for (int iter = 0; iter < nc; ++iter) {
            int k;
            int i;
            int grow = 4 + world.field_73012_v.nextInt(3);
