...
extends BlockReed {
    ...
    public void func_149734_b(World par1World, int par2, int par3, int par4, Random par5Random) {
        for (int j1 = 0; j1 < 5; ++j1) {
            par1World.func_72869_a("fireworksSpark", (double)((float)par2 + par1World.field_73012_v.nextFloat()), (double)par3 + (double)par1World.field_73012_v.nextFloat(), (double)((float)par4 + par1World.field_73012_v.nextFloat()), (double)(par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0, (double)par1World.field_73012_v.nextFloat() / 2.0, (double)(par1World.field_73012_v.nextFloat() - par1World.field_73012_v.nextFloat()) / 4.0);
        }
    }
    ...
    public void func_149726_b(World world, int x, int y, int z) {
        ...
        world.func_147464_a(x, y, z, (Block)this, 400);
    }
    ...
    public void func_149674_a(World world, int clickedX, int clickedY, int clickedZ, Random par5Random) {
        ...
        world.func_147465_d(clickedX, clickedY, clickedZ, Blocks.field_150350_a, 0, 2);
        world.func_147465_d(clickedX, clickedY + 1, clickedZ, Blocks.field_150350_a, 0, 2);
        int type = world.field_73012_v.nextInt(50);
        if (type == 0) {
