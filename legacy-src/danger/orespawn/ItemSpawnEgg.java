...
extends Item {
    ...
    public boolean func_77648_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
        ...
        Entity ent = ItemSpawnEgg.spawn_something(this.my_id, par3World, (double)par4 + 0.5, (double)par5 + 1.01, (double)par6 + 0.5);
    ...
    public static Entity spawn_something(int id, World world, double d0, double d1, double d2) {
        ...
        Entity ent = null;
        if ((entityID != 0 || name != null) && (ent = ItemSpawnEgg.spawnCreature(world, entityID, name, d0, d1, d2)) != null && entityID == 51 && skelly_type != 0) {
