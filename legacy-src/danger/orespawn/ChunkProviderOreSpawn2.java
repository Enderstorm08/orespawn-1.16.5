...
implements IChunkProvider {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2) {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3) {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3) {
                                double d;
                                d15 += d16;
                                p_147424_3_[j3 += short1] = d > 0.0 ? Blocks.field_150348_b : (k2 * 8 + l2 < b0 ? Blocks.field_150355_j : null);
                            }
                            d10 += d12;
                            d11 += d13;
                        }
    ...
    public void func_73153_a(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        if (biomegenbase != BiomeGenBase.field_76769_d && biomegenbase != BiomeGenBase.field_76786_s && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate((IChunkProvider)par1IChunkProvider, (World)this.worldObj, (Random)this.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        for (k1 = 0; doGen && k1 < 16; ++k1) {
            for (l1 = 0; l1 < 16; ++l1) {
                ...
                if (this.worldObj.func_72884_u(k1 + k, i2 - 1, l1 + l)) {
                    this.worldObj.func_147465_d(k1 + k, i2 - 1, l1 + l, Blocks.field_150432_aD, 0, 2);
                }
                if (!this.worldObj.func_147478_e(k1 + k, i2, l1 + l, true)) continue;
                this.worldObj.func_147465_d(k1 + k, i2, l1 + l, Blocks.field_150431_aC, 0, 2);
            }
        }
    ...
    public List func_73155_a(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
        ...
        List l = null;
        if (var5 != null) {
            l = var5.func_76747_a(par1EnumCreatureType);
            if (par1EnumCreatureType == EnumCreatureType.monster) {
                if (this.MyMobList == null) {
                    ...
                    for (BiomeGenBase.SpawnListEntry var3 : l) {
            ...
            if (par1EnumCreatureType == EnumCreatureType.ambient) {
                if (this.MyAmbientList == null) {
                    ...
                    if (OreSpawnMain.VelocityRaptorEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(VelocityRaptor.class, 5, 2, 4));
                    }
                    if (OreSpawnMain.DragonflyEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Dragonfly.class, 10, 1, 3));
                    }
                    if (OreSpawnMain.CamarasaurusEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Camarasaurus.class, 3, 2, 4));
                    }
                    if (OreSpawnMain.BaryonyxEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(Baryonyx.class, 10, 4, 8));
                    }
                    for (BiomeGenBase.SpawnListEntry var3 : l) {
