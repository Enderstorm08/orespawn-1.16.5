...
extends EntityTameable {
    ...
    public Dragon(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 9.0f));
    ...
    private boolean scan_it(int x, int y, int z, int dx, int dy, int dz) {
        ...
        for (i = -dy; i <= dy; ++i) {
            for (j = -dz; j <= dz; ++j) {
                ...
                if ((bid == Blocks.field_150353_l || bid == Blocks.field_150356_k) && (d = dx * dx + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + dx;
                    this.ty = y + i;
                    this.tz = z + j;
                ...
                if ((bid = this.field_70170_p.func_147439_a(x - dx, y + i, z + j)) != Blocks.field_150353_l && bid != Blocks.field_150356_k || (d = dx * dx + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x - dx;
                this.ty = y + i;
                this.tz = z + j;
        ...
        for (i = -dx; i <= dx; ++i) {
            for (j = -dz; j <= dz; ++j) {
                ...
                if ((bid == Blocks.field_150353_l || bid == Blocks.field_150356_k) && (d = dy * dy + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + i;
                    this.ty = y + dy;
                    this.tz = z + j;
                ...
                if ((bid = this.field_70170_p.func_147439_a(x + i, y - dy, z + j)) != Blocks.field_150353_l && bid != Blocks.field_150356_k || (d = dy * dy + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y - dy;
                this.tz = z + j;
        ...
        for (i = -dx; i <= dx; ++i) {
            for (j = -dy; j <= dy; ++j) {
                ...
                if ((bid == Blocks.field_150353_l || bid == Blocks.field_150356_k) && (d = dz * dz + j * j + i * i) < this.closest) {
                    this.closest = d;
                    this.tx = x + i;
                    this.ty = y + j;
                    this.tz = z + dz;
                ...
                if ((bid = this.field_70170_p.func_147439_a(x + i, y + j, z - dz)) != Blocks.field_150353_l && bid != Blocks.field_150356_k || (d = dz * dz + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y + j;
                this.tz = z - dz;
    ...
    protected void func_70628_a(boolean par1, int par2) {
        int i = 1 + this.field_70170_p.field_73012_v.nextInt(6);
    ...
    public void always_do() {
        ...
        if (this.func_70909_n() && this.func_70902_q() != null && !this.func_70906_o() && this.func_70068_e((Entity)(p = (EntityPlayer)this.func_70902_q())) > 400.0) {
            this.setActivity(1);
        }
    ...
    public boolean func_70601_bi() {
        ...
        target = (Dragon)this.field_70170_p.func_72857_a(Dragon.class, this.field_70121_D.func_72314_b(16.0, 6.0, 16.0), (Entity)this);
        if (target != null) {
            return false;
        }
    ...
    public void func_70071_h_() {
        ...
        if (this.getActivity() == 0 && this.func_70909_n() && this.func_70902_q() != null && !this.func_70906_o() && this.func_70068_e((Entity)(e = this.func_70902_q())) > 144.0) {
            this.setActivity(1);
        }
    }
    ...
    private void fly_without_rider() {
        ...
        if (!toofar && this.unstick_timer == 0 && this.flyaway == 0 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.field_70170_p.field_73012_v.nextInt(9) == 1) {
            e = this.findSomethingToAttack();
            if (e != null) {
                    ...
                    if (this.func_70068_e((Entity)e) < (double)((5.0f + e.field_70130_N / 2.0f) * (5.0f + e.field_70130_N / 2.0f))) {
                        ...
                        if (this.dragontype == 0) {
                            if (this.getDragonFire() == 1) {
                                sf = new EntitySmallFireball(this.field_70170_p, (EntityLivingBase)this, e.field_70165_t - cx, e.field_70163_u + (double)(e.field_70131_O / 2.0f) - (this.field_70163_u + yoff), e.field_70161_v - cz);
                            ...
                            wb = new WaterBall(this.field_70170_p, e.field_70165_t - this.field_70165_t, e.field_70163_u + (double)(e.field_70131_O / 2.0f) - (this.field_70163_u + yoff), e.field_70161_v - this.field_70161_v);
                            ...
                            var3 = e.field_70165_t - wb.field_70165_t;
                            var5 = e.field_70163_u + 0.25 - wb.field_70163_u;
                            var7 = e.field_70161_v - wb.field_70161_v;
                            var9 = MathHelper.func_76133_a((double)(var3 * var3 + var7 * var7)) * 0.2f;
                            wb.func_70186_c(var3, var5 + (double)var9, var7, 1.4f, 5.0f);
                            this.field_70170_p.func_72956_a((Entity)this, "random.bow", 0.75f, 1.0f / (this.func_70681_au().nextFloat() * 0.4f + 0.8f));
                            this.field_70170_p.func_72838_d((Entity)wb);
                        } else {
                            ib = new IceBall(this.field_70170_p, e.field_70165_t - this.field_70165_t, e.field_70163_u + (double)(e.field_70131_O / 2.0f) - (this.field_70163_u + yoff), e.field_70161_v - this.field_70161_v);
                            ...
                            ib.setSpecial();
                            ib.setIceBall();
                            var3 = e.field_70165_t - ib.field_70165_t;
                            var5 = e.field_70163_u + 0.25 - ib.field_70163_u;
                            var7 = e.field_70161_v - ib.field_70161_v;
                            var9 = MathHelper.func_76133_a((double)(var3 * var3 + var7 * var7)) * 0.2f;
                            ib.func_70186_c(var3, var5 + (double)var9, var7, 1.4f, 5.0f);
                            this.field_70170_p.func_72956_a((Entity)this, "random.fuse", 1.0f, 1.0f / (this.func_70681_au().nextFloat() * 0.4f + 0.8f));
                    ...
                    if (this.fireballticker == 0) {
                        ...
                        if (this.getDragonType() == 0) {
                            ...
                            if (pp.field_70702_br > 0.001f) {
                                ...
                                cy = -Math.sin(Math.toRadians(pp.field_70125_A));
                                d3 = MathHelper.func_76133_a((double)(cx * cx + cy * cy + cz * cz));
                                bf.field_70232_b = cx / d3 * 0.15;
                                bf.field_70233_c = cy / d3 * 0.15;
                                bf.field_70230_d = cz / d3 * 0.15;
                                bf.field_70159_w = this.field_70159_w;
                                bf.field_70181_x = this.field_70181_x;
                                bf.field_70179_y = this.field_70179_y;
                                bf.field_70165_t -= this.field_70159_w * 9.0;
                                bf.field_70163_u -= this.field_70181_x * 9.0;
                                bf.field_70161_v -= this.field_70179_y * 9.0;
                                this.field_70170_p.func_72956_a((Entity)this, "random.bow", 0.75f, 1.0f / (this.func_70681_au().nextFloat() * 0.4f + 0.8f));
                                this.field_70170_p.func_72838_d((Entity)bf);
                            ...
                            if (pp.field_70702_br > 0.001f) {
                                cx = this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z));
                                cz = this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z));
                                var2 = new WaterBall(this.field_70170_p, cx, this.field_70163_u + yoff, cz);
                                var2.func_70012_b(cx, this.field_70163_u + yoff, cz, pp.field_70177_z + 90.0f, pp.field_70125_A);
                                var3 = Math.cos(Math.toRadians(pp.field_70759_as + 90.0f));
                                var5 = -Math.sin(Math.toRadians(pp.field_70125_A));
                                var77 = Math.sin(Math.toRadians(pp.field_70759_as + 90.0f));
                                var9 = MathHelper.func_76133_a((double)(var3 * var3 + var77 * var77)) * 0.2f;
                                var2.func_70186_c(var3, var5 + (double)var9, var77, 1.4f, 5.0f);
                                var2.field_70165_t -= this.field_70159_w * 7.0;
                                var2.field_70163_u -= this.field_70181_x * 7.0;
                                var2.field_70161_v -= this.field_70179_y * 7.0;
                                this.field_70170_p.func_72956_a((Entity)this, "random.bow", 0.75f, 1.0f / (this.func_70681_au().nextFloat() * 0.4f + 0.8f));
                            ...
                            if (pp.field_70702_br < -0.001f) {
                                cx = this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z));
                                cz = this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z));
                                var2 = new IceBall(this.field_70170_p, cx, this.field_70163_u + yoff, cz);
                                var2.func_70012_b(cx, this.field_70163_u + yoff, cz, pp.field_70177_z + 90.0f, pp.field_70125_A);
                                var2.setSpecial();
                                var2.setIceBall();
                                var3 = Math.cos(Math.toRadians(pp.field_70177_z + 90.0f));
                                var5 = -Math.sin(Math.toRadians(pp.field_70125_A));
                                var77 = Math.sin(Math.toRadians(pp.field_70177_z + 90.0f));
                                var9 = MathHelper.func_76133_a((double)(var3 * var3 + var77 * var77)) * 0.2f;
                                var2.func_70186_c(var3, var5 + (double)var9, var77, 1.4f, 5.0f);
                                var2.field_70165_t -= this.field_70159_w * 7.0;
                                var2.field_70163_u -= this.field_70181_x * 7.0;
    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (!this.func_70909_n()) {
            ...
            if (var2 != null && var2.func_77973_b() == Item.func_150898_a((Block)Blocks.field_150432_aD) && par1EntityPlayer.func_70068_e((Entity)this) < 25.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer)) {
                if (!this.field_70170_p.field_72995_K) {
                    this.func_70908_e(true);
                    this.field_70170_p.func_72960_a((Entity)this, (byte)6);
            ...
            if (var2 != null && var2.func_77973_b() == Items.field_151045_i && par1EntityPlayer.func_70068_e((Entity)this) < 25.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer) && !this.field_70170_p.field_72995_K) {
                Entity ent = null;
                Spyro d = null;
                ent = Dragon.spawnCreature(this.field_70170_p, "Baby Dragon", this.field_70165_t, this.field_70163_u, this.field_70161_v);
                if (ent != null) {
                    d = (Spyro)ent;
                    if (this.func_70909_n()) {
                        d.func_70903_f(true);
    ...
    public void func_70037_a(NBTTagCompound par1NBTTagCompound) {
        ...
        this.dragontype = par1NBTTagCompound.func_74762_e("DragonType");
        this.setDragonType(this.dragontype);
    }
}
