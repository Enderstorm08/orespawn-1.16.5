...
extends EntityMob {
    ...
    protected Item func_146068_u() {
        return Item.func_150898_a((Block)Blocks.field_150339_S);
    }
    ...
    protected void func_70628_a(boolean par1, int par2) {
        int var4;
        ItemStack is = null;
        int var5 = 2 + this.field_70170_p.field_73012_v.nextInt(8);
    ...
    protected void destroyBlock(EntityLivingBase e) {
        double z;
        double y;
        double x = e.field_70165_t + (double)this.field_70170_p.field_73012_v.nextFloat() - (double)this.field_70170_p.field_73012_v.nextFloat();
        Block bid = this.field_70170_p.func_147439_a((int)x, (int)(y = e.field_70163_u - 1.0), (int)(z = e.field_70161_v + (double)this.field_70170_p.field_73012_v.nextFloat() - (double)this.field_70170_p.field_73012_v.nextFloat()));
    ...
    protected void destroyNearbyBlocks() {
        for (int i = 0; i < 50; ++i) {
            double z;
            double y;
            double x = this.field_70165_t + (double)this.field_70170_p.field_73012_v.nextFloat() * 6.5 - (double)this.field_70170_p.field_73012_v.nextFloat() * 6.5;
            Block bid = this.field_70170_p.func_147439_a((int)x, (int)(y = this.field_70163_u + 0.1 + (double)this.field_70170_p.field_73012_v.nextFloat() * 8.5), (int)(z = this.field_70161_v + (double)this.field_70170_p.field_73012_v.nextFloat() * 6.5 - (double)this.field_70170_p.field_73012_v.nextFloat() * 6.5));
            if (bid == Blocks.field_150343_Z || bid == Blocks.field_150357_h || bid == Blocks.field_150371_ca || bid == Blocks.field_150474_ac || bid == Blocks.field_150451_bX || bid == Blocks.field_150339_S || bid == Blocks.field_150486_ae || bid == Blocks.field_150350_a || !this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) continue;
            this.field_70170_p.func_147449_b((int)x, (int)y, (int)z, Blocks.field_150350_a);
        }
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(14.0, 3.0, 14.0));
