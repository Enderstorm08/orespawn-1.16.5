...
extends EntityMob {
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        int i = 4 + this.field_70170_p.field_73012_v.nextInt(8);
    ...
    public boolean func_70652_k(Entity par1Entity) {
        ...
        if (super.func_70652_k(par1Entity)) {
            if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
                ...
                par1Entity.func_70024_g(Math.cos(f3) * ks, inair * (double)Math.abs(this.field_70170_p.field_73012_v.nextFloat()), Math.sin(f3) * ks);
            }
            return true;
        }
        return false;
    ...
    public boolean func_70601_bi() {
        ...
        target = (HerculesBeetle)this.field_70170_p.func_72857_a(HerculesBeetle.class, this.field_70121_D.func_72314_b(16.0, 6.0, 16.0), (Entity)this);
        return target == null;
    }
}
