...
extends EntityMob {
    ...
    public void func_70636_d() {
        super.func_70636_d();
        this.moveSpeed = this.func_70090_H() ? 0.75f : 0.25f;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(18.0, 4.0, 18.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (SeaViper)this.field_70170_p.func_72857_a(SeaViper.class, this.field_70121_D.func_72314_b(16.0, 5.0, 16.0), (Entity)this);
        return target == null;
    }
