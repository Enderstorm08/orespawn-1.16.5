...
extends EntityMob {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)OreSpawnMain.EmperorScorpion_stats.attack);
    }
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        int i = 4 + this.field_70170_p.field_73012_v.nextInt(5);
        for (var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(Item.func_150898_a((Block)Blocks.field_150343_Z), 1);
        }
        i = 4 + this.field_70170_p.field_73012_v.nextInt(8);
        for (var4 = 0; var4 < i; ++var4) {
        ...
        block17: for (var4 = 0; var4 < i; ++var4) {
            ...
            switch (var3) {
                ...
                case 2: {
                    ItemStack is = this.dropItemRand(Item.func_150898_a((Block)Blocks.field_150484_ah), 1);
                    continue block17;
                }
                case 3: {
                    ItemStack is = this.dropItemRand(Items.field_151048_u, 1);
                ...
                case 4: {
                    ItemStack is = this.dropItemRand(Items.field_151047_v, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(2) == 1) {
                        is.func_77966_a(Enchantment.field_77347_r, 2 + this.field_70170_p.field_73012_v.nextInt(4));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) != 1) continue block17;
                ...
                case 5: {
                    ItemStack is = this.dropItemRand(Items.field_151046_w, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(2) == 1) {
                        is.func_77966_a(Enchantment.field_77347_r, 2 + this.field_70170_p.field_73012_v.nextInt(4));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                case 6: {
                    ItemStack is = this.dropItemRand(Items.field_151056_x, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(2) == 1) {
                        is.func_77966_a(Enchantment.field_77347_r, 2 + this.field_70170_p.field_73012_v.nextInt(4));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) != 1) continue block17;
                ...
                case 7: {
                    ItemStack is = this.dropItemRand(Items.field_151012_L, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(2) == 1) {
                        is.func_77966_a(Enchantment.field_77347_r, 2 + this.field_70170_p.field_73012_v.nextInt(4));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) != 1) continue block17;
                ...
                case 8: {
                    ItemStack is = this.dropItemRand((Item)Items.field_151161_ac, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                case 9: {
                    ItemStack is = this.dropItemRand((Item)Items.field_151163_ad, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                        is.func_77966_a(Enchantment.field_77332_c, 1 + this.field_70170_p.field_73012_v.nextInt(5));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                case 10: {
                    ItemStack is = this.dropItemRand((Item)Items.field_151173_ae, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                        is.func_77966_a(Enchantment.field_77332_c, 1 + this.field_70170_p.field_73012_v.nextInt(5));
                    }
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                case 11: {
                    ItemStack is = this.dropItemRand((Item)Items.field_151175_af, 1);
                    if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
        ...
        if (super.func_70652_k(par1Entity)) {
            if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
                ...
                if (this.field_70170_p.field_73012_v.nextInt(3) == 1) {
                    ((EntityLivingBase)par1Entity).func_70690_d(new PotionEffect(Potion.field_76436_u.field_76415_H, var2 * 15, 0));
                }
        ...
        if (this.field_70170_p.field_73012_v.nextInt(4) == 0) {
            ...
            if (e != null) {
                ...
                if (this.func_70068_e((Entity)e) < (double)((6.0f + e.field_70130_N / 2.0f) * (6.0f + e.field_70130_N / 2.0f))) {
                    this.setAttacking(1);
                    if (this.field_70170_p.field_73012_v.nextInt(4) == 0 || this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                ...
                if (this.field_70170_p.field_73012_v.nextInt(20) == 1) {
                    EntityCreature entityCreature = (EntityCreature)EmperorScorpion.spawnCreature(this.field_70170_p, "Scorpion", (this.field_70165_t + e.field_70165_t) / 2.0 + (double)this.field_70170_p.field_73012_v.nextInt(5) - (double)this.field_70170_p.field_73012_v.nextInt(5), (this.field_70163_u + e.field_70163_u) / 2.0 + 1.01, (this.field_70161_v + e.field_70161_v) / 2.0 + (double)this.field_70170_p.field_73012_v.nextInt(5) - (double)this.field_70170_p.field_73012_v.nextInt(5));
                }
            } else {
                this.setAttacking(0);
            }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(24.0, 6.0, 24.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (EmperorScorpion)this.field_70170_p.func_72857_a(EmperorScorpion.class, this.field_70121_D.func_72314_b(20.0, 6.0, 20.0), (Entity)this);
        return target == null;
    }
}
