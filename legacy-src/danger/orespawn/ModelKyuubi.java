...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? MathHelper.func_76134_b((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : 0.0f;
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.08f * f1;
        this.rtArmUpper.field_78795_f = newangle += MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.01f;
        ...
        this.lfHorn1.field_78796_g = this.headFire.field_78796_g + 0.244f + MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn2.field_78796_g = this.headFire.field_78796_g + 0.244f + MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn3.field_78796_g = this.headFire.field_78796_g + 0.244f + MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn4.field_78796_g = this.headFire.field_78796_g + 0.244f + MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn5.field_78796_g = this.headFire.field_78796_g + 0.244f + MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn1.field_78796_g = this.headFire.field_78796_g + -0.244f - MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn2.field_78796_g = this.headFire.field_78796_g + -0.244f - MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn3.field_78796_g = this.headFire.field_78796_g + -0.244f - MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn4.field_78796_g = this.headFire.field_78796_g + -0.244f - MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn5.field_78796_g = this.headFire.field_78796_g + -0.244f - MathHelper.func_76134_b((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        this.tail1.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.2f;
        this.tail2.field_78800_c = this.tail1.field_78800_c - (float)Math.sin(this.tail1.field_78796_g) * 3.0f;
        this.tail2.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - pi4)) * (float)Math.PI * 0.2f;
        this.tail3.field_78800_c = this.tail2.field_78800_c - (float)Math.sin(this.tail2.field_78796_g) * 4.0f;
        this.tail3.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail4.field_78800_c = this.tail3.field_78800_c - (float)Math.sin(this.tail3.field_78796_g) * 3.5f;
        this.tail4.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail5.field_78800_c = this.tail4.field_78800_c - (float)Math.sin(this.tail4.field_78796_g) * 5.0f;
        this.tail5.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail6.field_78800_c = this.tail5.field_78800_c - (float)Math.sin(this.tail5.field_78796_g) * 4.0f;
        this.tail6.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail7.field_78800_c = this.tail6.field_78800_c - (float)Math.sin(this.tail6.field_78796_g) * 3.0f;
        this.tail7.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail8.field_78800_c = this.tail7.field_78800_c - (float)Math.sin(this.tail7.field_78796_g) * 2.0f;
        this.tail8.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail9.field_78800_c = this.tail8.field_78800_c - (float)Math.sin(this.tail8.field_78796_g) * 1.0f;
        this.tail9.field_78796_g = MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail1.field_78795_f = -0.26f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.tail2.field_78795_f = -0.78f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail3.field_78795_f = -1.11f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail4.field_78795_f = -0.18f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail5.field_78795_f = 0.22f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail6.field_78795_f = 0.63f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail7.field_78795_f = 0.89f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail8.field_78795_f = 1.52f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail9.field_78795_f = 2.0f + MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.1f;
        GL11.glPushMatrix();
