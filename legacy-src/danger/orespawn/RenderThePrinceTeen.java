...
extends RenderLiving {
    protected ModelThePrinceTeen model = (ModelThePrinceTeen)this.field_77045_g;
    ...
    public void renderThePrinceTeen(ThePrinceTeen par1EntityThePrinceTeen, double par2, double par4, double par6, float par8, float par9) {
        super.func_76986_a((EntityLiving)par1EntityThePrinceTeen, par2, par4, par6, par8, par9);
    }
