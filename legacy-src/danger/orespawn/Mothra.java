...
implements IMob {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)OreSpawnMain.Mothra_stats.attack);
    }
    ...
    protected void func_70619_bc() {
        ...
        if (this.stuck_count > 50 || this.field_70170_p.field_73012_v.nextInt(300) == 0 || this.currentFlightTarget.func_71569_e((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v) < 9.0f) {
            ...
            this.stuck_count = 0;
        } else if (this.field_70170_p.field_73012_v.nextInt(10) == 0 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && OreSpawnMain.MothraPeaceful == 0) {
            EntityPlayer target = null;
            target = (EntityPlayer)this.field_70170_p.func_72857_a(EntityPlayer.class, this.field_70121_D.func_72314_b(25.0, 20.0, 25.0), (Entity)this);
            if (target != null) {
    ...
    public boolean func_70601_bi() {
        ...
        Mothra target = null;
        target = (Mothra)this.field_70170_p.func_72857_a(Mothra.class, this.field_70121_D.func_72314_b(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        for (var4 = 0; var4 < 3; ++var4) {
            this.dropItemRand(Items.field_151072_bj, 1);
        }
        this.dropItemRand(Items.field_151156_bN, 1);
        for (var4 = 0; var4 < 20; ++var4) {
            Mothra.spawnCreature(this.field_70170_p, "Moth", this.field_70165_t + 0.5, this.field_70163_u + 1.0, this.field_70161_v + 0.5);
        }
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(15.0, 20.0, 15.0));
