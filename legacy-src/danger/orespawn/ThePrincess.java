...
extends EntityTameable {
    ...
    protected float func_70647_i() {
        return (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) * 0.2f + 1.5f;
    }
    ...
    public void func_70071_h_() {
        ...
        if (this.field_70170_p.field_72995_K && this.getPower() > 400) {
            float f = 0.25f;
            if (this.field_70170_p.field_73012_v.nextInt(6) == 1) {
                for (i = 0; i < 2; ++i) {
                    this.field_70170_p.func_72869_a("fireworksSpark", this.field_70165_t - (double)f * Math.sin(Math.toRadians(this.field_70177_z)), this.field_70163_u + 0.4, this.field_70161_v + (double)f * Math.cos(Math.toRadians(this.field_70177_z)), (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0 + this.field_70159_w * 3.0, (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0, (this.field_70170_p.field_73012_v.nextGaussian() - this.field_70170_p.field_73012_v.nextGaussian()) / 7.0 + this.field_70179_y * 3.0);
                }
            }
        }
    }
    ...
    protected void func_70619_bc() {
        ...
        if (this.attack_level > 500) {
            if (this.getAttacking() != 0) {
                int j = 3;
                for (int i = 0; i < j; ++i) {
                    Entity ppwr = ThePrincess.spawnCreature(this.field_70170_p, "PurplePower", this.field_70165_t - xzoff * Math.sin(Math.toRadians(this.field_70177_z)), this.field_70163_u + yoff, this.field_70161_v + xzoff * Math.cos(Math.toRadians(this.field_70177_z)));
                    if (ppwr == null) continue;
                    PurplePower p2 = (PurplePower)ppwr;
                    p2.field_70159_w = this.field_70159_w * 3.0;
                    p2.field_70179_y = this.field_70179_y * 3.0;
                    p2.setPurpleType(1 + this.field_70170_p.field_73012_v.nextInt(3));
                }
            } else {
                Block bid;
                int j;
                ...
                if (this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
                    block1: for (m = 0; m < 5; ++m) {
                        i = this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5);
                        k = this.field_70170_p.field_73012_v.nextInt(5) - this.field_70170_p.field_73012_v.nextInt(5);
                        for (j = -5; j < 5; ++j) {
                            ...
                            if (bid == Blocks.field_150349_c) {
                                ...
                                int which = this.field_70170_p.field_73012_v.nextInt(8);
                                if (which == 0) {
                ...
                for (m = 0; m < 2; ++m) {
                    i = this.field_70170_p.field_73012_v.nextInt(4) - this.field_70170_p.field_73012_v.nextInt(4);
                    k = this.field_70170_p.field_73012_v.nextInt(4) - this.field_70170_p.field_73012_v.nextInt(4);
                    j = 1 + this.field_70170_p.field_73012_v.nextInt(4);
                    bid = this.field_70170_p.func_147439_a((int)this.field_70165_t + i, (int)this.field_70163_u + j, (int)this.field_70161_v + k);
                    if (bid != Blocks.field_150350_a) continue;
                    newent = this.field_70170_p.field_73012_v.nextInt(2) == 0 ? (EntityLiving)ThePrincess.spawnCreature(this.field_70170_p, "Butterfly", this.field_70165_t + (double)i, this.field_70163_u + (double)j, this.field_70161_v + (double)k) : (EntityLiving)ThePrincess.spawnCreature(this.field_70170_p, "Bird", this.field_70165_t + (double)i, this.field_70163_u + (double)j, this.field_70161_v + (double)k);
                }
            }
            this.attack_level = 1;
        }
