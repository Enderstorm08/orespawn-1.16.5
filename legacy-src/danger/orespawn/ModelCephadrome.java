...
extends ModelBase {
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.001) {
            ...
            newangle = MathHelper.func_76134_b((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * lspeed * 0.4f;
        ...
        newangle = e.getActivity() != 0 ? MathHelper.func_76134_b((float)(f2 * 0.55f * this.wingspeed)) * (float)Math.PI * 0.28f : (e.getAttacking() == 0 ? -0.85f + MathHelper.func_76134_b((float)(f2 * 0.2f * this.wingspeed)) * (float)Math.PI * 0.028f : -0.65f + MathHelper.func_76134_b((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.068f);
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 0.15f * this.wingspeed)) * (float)Math.PI * 0.05f;
        ...
        this.tailfin1.field_78796_g = MathHelper.func_76134_b((float)(f2 * tailspeed * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * tailamp;
        ...
        newangle = MathHelper.func_76134_b((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.14f;
        this.mouth.field_78795_f = e.getAttacking() != 0 ? -0.61f + newangle : -0.87f;
        e.setRenderInfo(r);
