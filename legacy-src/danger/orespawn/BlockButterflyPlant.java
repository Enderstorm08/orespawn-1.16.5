...
extends BlockCrops {
    ...
    public void func_149674_a(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (bid == Blocks.field_150350_a && par1World.func_72935_r() && OreSpawnMain.ButterflyEnable != 0) {
            BlockButterflyPlant.spawnCreature(par1World, "Butterfly", (double)par2 + 0.5, (double)par3 + 1.01, (double)par4 + 0.5);
        }
    }
    ...
    public void func_149651_a(IIconRegister par1IIconRegister) {
        ...
        for (int i = 0; i < this.field_94364_a.length; ++i) {
            this.field_94364_a[i] = par1IIconRegister.func_94245_a("OreSpawn:butterfly_" + i);
        }
    }
}
