...
extends EntityLiving {
    ...
    public boolean func_70097_a(DamageSource par1DamageSource, float par2) {
        ...
        List var5 = this.field_70170_p.func_72872_a(Godzilla.class, this.field_70121_D.func_72314_b(32.0, 32.0, 32.0));
    ...
    public void func_70071_h_() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if (var2.hasNext()) {
                var3 = (Entity)var2.next();
                var4 = (Godzilla)var3;
                this.field_70163_u = var4.field_70163_u + 16.0;
                this.field_70165_t = var4.field_70165_t - 17.0 * Math.sin(Math.toRadians(var4.field_70759_as));
                this.field_70161_v = var4.field_70161_v + 17.0 * Math.cos(Math.toRadians(var4.field_70759_as));
