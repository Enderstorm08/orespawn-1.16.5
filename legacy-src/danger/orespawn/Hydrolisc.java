...
extends EntityTameable {
    ...
    protected void func_70629_bd() {
        ...
        if (!this.func_70906_o() && (this.field_70170_p.field_73012_v.nextInt(20) == 0 && (float)this.getHydroHealth() < this.func_110138_aP() || this.field_70170_p.field_73012_v.nextInt(100) == 0)) {
            this.closest = 99999;
            this.tz = 0;
            this.ty = 0;
            this.tx = 0;
        ...
        if (this.field_70170_p.field_73012_v.nextInt(10) == 0 && this.func_70909_n() && (e = this.func_70902_q()) != null && e.func_110143_aJ() < e.func_110138_aP() && this.getHydroHealth() > 20) {
            e.func_70691_i(1.0f);
            this.func_70691_i(-1.0f);
        }
    }
