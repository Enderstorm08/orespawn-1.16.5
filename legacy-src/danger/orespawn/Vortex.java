...
extends EntityMob {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)OreSpawnMain.Vortex_stats.attack);
    }
    ...
    public void func_70071_h_() {
        ...
        if (e != null) {
            ...
            if (this.field_70170_p.field_72995_K) {
                for (int i = 0; i < 20; ++i) {
                    ...
                    this.field_70170_p.func_72869_a("smoke", this.field_70165_t + dx, this.field_70163_u + 0.75 + d, this.field_70161_v + dz, Math.cos(dir += 1.5707963267948966) * (double)this.field_70170_p.field_73012_v.nextFloat() / 4.0, (double)(this.field_70170_p.field_73012_v.nextFloat() / 2.0f), Math.sin(dir) * (double)this.field_70170_p.field_73012_v.nextFloat() / 4.0);
                }
            }
        }
        ...
        if ((t %= 24000L) < 12000L && this.field_70170_p.field_73012_v.nextInt(500) == 1) {
            this.func_70106_y();
        }
    }
    ...
    protected void func_70619_bc() {
        ...
        if ((e = this.findSomethingToAttack()) != null) {
            ...
            if (d < 81.0 && this.winded == 0) {
                ...
                e.func_70024_g(Math.cos(a) * (10.0 - Math.sqrt(d)) * (double)0.1f, (10.0 - Math.sqrt(d)) * (double)0.05f * pm, Math.sin(a) * (10.0 - Math.sqrt(d)) * (double)0.1f);
            }
            if (this.func_70068_e((Entity)e) < (double)((4.0f + e.field_70130_N / 2.0f) * (4.0f + e.field_70130_N / 2.0f)) && this.field_70146_Z.nextInt(8) == 2) {
    ...
    public boolean func_70601_bi() {
        ...
        Vortex target = null;
        target = (Vortex)this.field_70170_p.func_72857_a(Vortex.class, this.field_70121_D.func_72314_b(20.0, 16.0, 20.0), (Entity)this);
        return target == null;
    }
    ...
    private boolean isSuitableTarget(EntityLivingBase par1EntityLiving, boolean par2) {
        ...
        return !(par1EntityLiving instanceof Urchin);
    }
    ...
    private ItemStack dropItemRand(Item index, int par1) {
        ...
        var3 = new EntityItem(this.field_70170_p, this.field_70165_t + (double)OreSpawnMain.OreSpawnRand.nextInt(6) - (double)OreSpawnMain.OreSpawnRand.nextInt(6), this.field_70163_u + 1.0 + (double)this.field_70170_p.field_73012_v.nextInt(10), this.field_70161_v + (double)OreSpawnMain.OreSpawnRand.nextInt(6) - (double)OreSpawnMain.OreSpawnRand.nextInt(6), is);
        if (var3 != null) {
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        int i = 5 + this.field_70170_p.field_73012_v.nextInt(7);
        for (int var4 = 0; var4 < i; ++var4) {
            ...
            if (var3 != 8) continue;
            this.dropItemRand(Item.func_150898_a((Block)OreSpawnMain.CrystalCoal), 1);
        }
    }
