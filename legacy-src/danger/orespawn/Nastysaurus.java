...
extends EntityMob {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)OreSpawnMain.Nastysaurus_stats.attack);
    }
    ...
    private void dropItemRand(Item index, int par1) {
        EntityItem var3 = new EntityItem(this.field_70170_p, this.field_70165_t + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), this.field_70163_u + 3.0, this.field_70161_v + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), new ItemStack(index, par1, 0));
    ...
    protected void func_70619_bc() {
        ...
        if (this.field_70170_p.field_73012_v.nextInt(5) == 0) {
            ...
            if (e != null) {
                ...
                if (this.func_70068_e((Entity)e) < (double)((4.5f + e.field_70130_N / 2.0f) * (4.5f + e.field_70130_N / 2.0f))) {
                    this.setAttacking(1);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(32.0, 8.0, 32.0));
    ...
    public boolean func_70601_bi() {
        ...
        target = (Nastysaurus)this.field_70170_p.func_72857_a(Nastysaurus.class, this.field_70121_D.func_72314_b(16.0, 8.0, 16.0), (Entity)this);
        return target == null;
    }
}
