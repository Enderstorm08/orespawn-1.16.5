...
extends ModelBase {
    ...
    public ModelTRex(float f1) {
        ...
        this.Shape18.func_78793_a(3.3f, -25.0f, -23.0f);
        ...
        this.Shape19.func_78793_a(-4.0f, -24.0f, -23.0f);
        ...
        this.TailExtension.func_78789_a(0.0f, 0.0f, 0.0f, 3, 3, 10);
        this.TailExtension.func_78793_a(-1.0f, -19.0f, 59.0f);
        this.TailExtension.func_78787_b(128, 128);
        this.TailExtension.field_78809_i = true;
        this.setRotation(this.TailExtension, 0.0f, 0.0f, 0.0f);
        this.Spine1 = new ModelRenderer((ModelBase)this, 73, 0);
        this.Spine1.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 3);
        this.Spine1.func_78793_a(-1.0f, -21.0f, 0.0f);
        this.Spine1.func_78787_b(128, 128);
        ...
        this.Spine2.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 3);
        this.Spine2.func_78793_a(-0.5f, -21.0f, 6.0f);
        this.Spine2.func_78787_b(128, 128);
        ...
        this.Spine3.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 3);
        this.Spine3.func_78793_a(-0.5f, -21.0f, 12.0f);
        this.Spine3.func_78787_b(128, 128);
        ...
        this.Spine4.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 3);
        this.Spine4.func_78793_a(-0.5f, -24.0f, -9.0f);
        this.Spine4.func_78787_b(128, 128);
        ...
        this.Spine5.func_78789_a(0.0f, 0.0f, 0.0f, 2, 2, 3);
        this.Spine5.func_78793_a(-0.5f, -26.0f, -14.0f);
        this.Spine5.func_78787_b(128, 128);
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.TailExtension.func_78785_a(f5);
