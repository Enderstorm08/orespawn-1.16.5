...
extends EntityMob {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)OreSpawnMain.Robot5_stats.attack);
    }
        ...
        if (this.reload_ticker == 0) {
            ...
            if (e != null) {
                ...
                if (this.func_70068_e((Entity)e) < 900.0) {
                    ...
                    if (this.func_70068_e((Entity)e) > 36.0) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(30.0, 6.0, 30.0));
