...
extends EntityAmbientCreature {
    ...
    protected void func_70619_bc() {
        ...
        if (this.field_70170_p.field_73012_v.nextInt(40) == 1 || this.currentFlightTarget.func_71569_e((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v) < 2.0f) {
            ...
            if (target != null) {
                this.currentFlightTarget.func_71571_b((int)target.field_70165_t + this.field_70146_Z.nextInt(3) - this.field_70146_Z.nextInt(3), (int)(target.field_70163_u + 1.0), (int)target.field_70161_v + this.field_70146_Z.nextInt(3) - this.field_70146_Z.nextInt(3));
            } else {
