...
extends EntityLiving {
    ...
    public AntRobot(World par1World) {
        ...
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 12.0f));
        ...
        if (this.owned == 0 && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                ...
                if (this.func_70068_e((Entity)e) > 16.0) {
                    ...
                    this.goThisWay(0.25 * Math.cos(dd), 0.25 * Math.sin(dd));
                }
            } else {
                this.setAttacking(0);
            }
    ...
    public void func_70071_h_() {
        ...
        float f = 4.0f;
        float dx = (float)((double)f * Math.cos(Math.toRadians(this.field_70177_z - 80.0f)));
        float dz = (float)((double)f * Math.sin(Math.toRadians(this.field_70177_z - 80.0f)));
        float dx2 = (float)((double)f * Math.cos(Math.toRadians(this.field_70177_z - 90.0f)));
        float dz2 = (float)((double)f * Math.sin(Math.toRadians(this.field_70177_z - 90.0f)));
        if (this.field_70170_p.field_73012_v.nextInt(18) == 0) {
            this.field_70170_p.func_72869_a("flame", this.field_70165_t + (double)dx, this.field_70163_u + 0.5, this.field_70161_v + (double)dz, (double)(dx2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f), (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 10.0f), (double)(dz2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f));
        }
        if (this.field_70170_p.field_73012_v.nextInt(7) == 0) {
            this.field_70170_p.func_72869_a("smoke", this.field_70165_t + (double)dx, this.field_70163_u + 0.5, this.field_70161_v + (double)dz, (double)(dx2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f), (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 10.0f), (double)(dz2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f));
        }
        if (this.field_70170_p.field_73012_v.nextInt(16) == 0) {
            this.field_70170_p.func_72869_a("fireworksSpark", this.field_70165_t + (double)dx, this.field_70163_u + 0.5, this.field_70161_v + (double)dz, (double)(dx2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f), (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 5.0f), (double)(dz2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f));
        }
        dx = (float)((double)f * Math.cos(Math.toRadians(this.field_70177_z - 100.0f)));
        dz = (float)((double)f * Math.sin(Math.toRadians(this.field_70177_z - 100.0f)));
        if (this.field_70170_p.field_73012_v.nextInt(18) == 0) {
            this.field_70170_p.func_72869_a("flame", this.field_70165_t + (double)dx, this.field_70163_u + 0.5, this.field_70161_v + (double)dz, (double)(dx2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f), (double)((this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 10.0f), (double)(dz2 / f + (this.field_70170_p.field_73012_v.nextFloat() - this.field_70170_p.field_73012_v.nextFloat()) / 20.0f));
        }
        if (this.field_70170_p.field_73012_v.nextInt(7) == 0) {
    ...
    public boolean feetattackEntityAsMob(Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            ret = par1Entity.func_70097_a(DamageSource.func_76358_a((EntityLivingBase)this), (float)OreSpawnMain.AntRobot_stats.attack / 10.0f);
    ...
    private EntityLivingBase findSomethingToAttack(float distmul, boolean dircheck) {
        ...
        List var5 = this.field_70170_p.func_72872_a(EntityLivingBase.class, this.field_70121_D.func_72314_b(12.0 * (double)distmul, 12.0, 12.0 * (double)distmul));
        Iterator var2 = var5.iterator();
        Entity var3 = null;
        EntityLivingBase var4 = null;
        while (var2.hasNext()) {
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ItemStack is = null;
        int i = 7 + this.field_70170_p.field_73012_v.nextInt(7);
