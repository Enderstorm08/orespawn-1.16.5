...
extends ModelBase {
    ...
    public ModelCryolophosaurus(float f1) {
        ...
        this.Shape1.func_78789_a(0.0f, 0.0f, 0.0f, 8, 9, 18);
        ...
        this.Shape2.func_78789_a(0.0f, 0.0f, 0.0f, 6, 4, 11);
        ...
        this.Shape3.func_78789_a(0.0f, 0.0f, 0.0f, 6, 4, 10);
        ...
        this.jaw.func_78789_a(0.0f, 0.0f, 0.0f, 4, 9, 1);
        ...
        this.Shape5.func_78789_a(0.0f, 0.0f, 0.0f, 6, 6, 7);
        ...
        this.Shape6.func_78789_a(0.0f, 0.0f, 0.0f, 4, 4, 14);
        ...
        this.Shape7.func_78789_a(0.0f, 0.0f, 0.0f, 1, 4, 2);
        ...
        this.Shape9.func_78789_a(0.0f, 0.0f, 0.0f, 2, 4, 1);
        ...
        this.rightleg.func_78789_a(0.0f, 0.0f, 0.0f, 2, 10, 6);
        ...
        this.Shape11.func_78789_a(0.0f, 0.0f, 0.0f, 4, 3, 3);
        ...
        this.rightleg2.func_78789_a(0.0f, 7.0f, -5.0f, 2, 10, 3);
        ...
        this.rightleg3.func_78789_a(0.0f, 10.0f, 12.0f, 2, 7, 2);
        ...
        this.rightleg4.func_78789_a(0.0f, 20.0f, -5.0f, 2, 2, 6);
        ...
        this.leftleg.func_78789_a(0.0f, 0.0f, 0.0f, 2, 10, 6);
        ...
        this.Shape16.func_78789_a(0.0f, 0.0f, 0.0f, 1, 4, 2);
        ...
        this.leftleg2.func_78789_a(0.0f, 7.0f, -5.0f, 2, 10, 3);
        ...
        this.leftleg3.func_78789_a(0.0f, 10.0f, 12.0f, 2, 7, 2);
        ...
        this.leftleg4.func_78789_a(0.0f, 20.0f, -5.0f, 2, 2, 6);
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.jaw.field_78795_f = -1.15f + MathHelper.func_76134_b((float)(f2 * 0.28f)) * (float)Math.PI * 0.1f;
