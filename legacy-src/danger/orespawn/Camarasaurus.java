    ...
    private boolean scan_it(int x, int y, int z, int dx, int dy, int dz) {
        ...
        for (i = -dy; i <= dy; ++i) {
            for (j = -dz; j <= dz; ++j) {
                ...
                if ((bid = this.field_70170_p.func_147439_a(x - dx, y + i, z + j)) != Blocks.field_150362_t && bid != Blocks.field_150395_bd && bid != Blocks.field_150329_H && bid != Blocks.field_150434_aF && bid != Blocks.field_150398_cm || (d = dx * dx + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x - dx;
                this.ty = y + i;
                this.tz = z + j;
        ...
        for (i = -dx; i <= dx; ++i) {
            for (j = -dz; j <= dz; ++j) {
                ...
                if ((bid = this.field_70170_p.func_147439_a(x + i, y - dy, z + j)) != Blocks.field_150362_t && bid != Blocks.field_150395_bd && bid != Blocks.field_150329_H && bid != Blocks.field_150434_aF && bid != Blocks.field_150398_cm || (d = dy * dy + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y - dy;
                this.tz = z + j;
        ...
        for (i = -dx; i <= dx; ++i) {
            for (j = -dy; j <= dy; ++j) {
                ...
                if ((bid = this.field_70170_p.func_147439_a(x + i, y + j, z - dz)) != Blocks.field_150362_t && bid != Blocks.field_150395_bd && bid != Blocks.field_150329_H && bid != Blocks.field_150434_aF && bid != Blocks.field_150398_cm || (d = dz * dz + j * j + i * i) >= this.closest) continue;
                this.closest = d;
                this.tx = x + i;
                this.ty = y + j;
                this.tz = z - dz;
